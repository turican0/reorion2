...
//----- (000C6052) --------------------------------------------------------
char sub_C6052( int a1, int a2, int a3)
{
  int16_t i; // cx
  int v5; // eax
  int v6; // eax
...
//----- (000C60E9) --------------------------------------------------------
char sub_C60E9( int a1, int a2, int a3)
{
  int16_t i; // dx
  int v6; // eax
...
//----- (000C622A) --------------------------------------------------------
_BOOL1 sub_C622A( int a1, int a2)
{
  int v2; // ecx
  bool v3; // eax
  _BOOL1 result; // al
...
/* wave 182: generated by tools/compare/jumpout_gen.py - the original
   jumps into the tail at 0xC66FF */
int sub_C671B(void)
{
  int r1;
  int r2;
  ...
  r1 = sub_123E6C((int)(intptr_t)&unk_17CF4A, 1);
  r2 = sub_CDF5C(310);
  sub_14DF7(r2, 1024, 1);
  r3 = sub_123E6C((int)(intptr_t)&unk_17CF00, 1);
  return r3;
}
...
//----- (000C673D) --------------------------------------------------------
/* wave 182: generated by tools/compare/jumpout_gen.py - the original
   jumps into the tail at 0xC66DA */
int sub_C673D(void)
{
  int r1;
  int r2;
  ...
  r2 = sub_CDF5C(183);
  sub_14DF7(r2, 1024, 1);
  r3 = sub_123E6C((int)(intptr_t)&unk_17CF4A, 1);
  r4 = sub_CDF5C(310);
  sub_14DF7(r4, 0, 1);
  r5 = sub_123E6C((int)(intptr_t)&unk_17CF00, 1);
  return r5;
}
...
//----- (000C6762) --------------------------------------------------------
/* wave 182: generated by tools/compare/jumpout_gen.py - the original
   jumps into the tail at 0xC66FD */
int sub_C6762(void)
{
  int r1;
  int r2;
...
//----- (000C685B) --------------------------------------------------------
unsigned int sub_C685B( int a1, int a2, int a3, _WORD *a4, _BYTE *a5, int a6)
{
  unsigned int v7; // edx
  int v8; // eax
...
//----- (000C69B6) --------------------------------------------------------
int sub_C69B6( int a1, int a2, int a3, int a4, int a5,
        int a6, int a7,
...
//----- (000C6A43) --------------------------------------------------------
unsigned int sub_C6A43( int a1, int a2, int a3, int a4,
        int a5, int a6,
        int a7, int a8,
...
//----- (000C6B6B) --------------------------------------------------------
int sub_C6B6B( int a1, int a2, int a3)
{
  a2 = (int16_t)a2;   /* wave 181: the original reads only the low word (movsx) */
...
//----- (000C6CAE) --------------------------------------------------------
unsigned int sub_C6CAE(unsigned int result, int a2, int a3, int a4, int a5)
{
  int16_t v5; // si
...
//----- (000C6FF3) --------------------------------------------------------
int sub_C6FF3( int a1, int a2, int a3, int a4)
{
  int v6; // ecx
  int v7; // ebx
...
//----- (000C702E) --------------------------------------------------------
void sub_C702E( int a1, int16_t *a2)
{
  int v3; // eax
  int v4; // ebx
  bool v5; // eax
...
//----- (000C7318) --------------------------------------------------------
int sub_C7318( int a1, int a2, int a3, int a4, int a5)
{
...
//----- (000C7AB8) --------------------------------------------------------
char sub_C7AB8( int a1, int a2, int a3)
{
  char result; // al
...
void sub_C83C5()
{
  ...
  LODWORD(v1) = sub_127C27((int)aBuffer0Lbx_6, 73, dword_193174);
  WORD2(v1) = 320 - *(int16_t *)v1 / 2;
  LODWORD(v1) = *(int16_t *)((uint32_t)v1 + 2);
  ...
  return;   /* vlna 79: JUMPOUT byl NO-OP, cil 0xC7EFD je epilog funkce */
}
...
LABEL_7:
  ...
  return;   /* vlna 79: JUMPOUT byl NO-OP, cil 0xC7EFE je epilog funkce */
}
...
// CDBC3: using guessed type int nullsub_11(_DWORD);
// 182ACA: using guessed type char byte_182ACA;
// 1831AC: using guessed type int16_t word_1831AC;
// 1831AE: using guessed type char byte_1831AE;
// 1831C2: using guessed type int16_t word_1831C2;
...
// C8F9A: using guessed type int sub_C8F9A(_DWORD);
// 182ACA: using guessed type char byte_182ACA;
// 1831B0: using guessed type int16_t word_1831B0;
// 1831C2: using guessed type int16_t word_1831C2;
// 192B18: using guessed type int (uint8_t*)dword_192B18;
...
//----- (000C97DB) --------------------------------------------------------
int sub_C97DB(int a1, int a2, int a3, int a4)
{
  int16_t *v4; // esi
  int v5; // eax
  int16_t v6; // ax
...
//----- (000C9AA4) --------------------------------------------------------
int64_t sub_C9AA4( int a1, int a2, int a3)
{
  _BYTE *v4; // eax
  _WORD *v5; // ecx
  int v6; // eax
...
//----- (000C9EB0) --------------------------------------------------------
int16_t sub_C9EB0( int a1, int a2,
        int a3, int a4,
        int16_t *a5, int a6)
{
  int16_t *v6; // ebx
...
void sub_C9FC4( int a1)
{
  ...
  v17 = (int16_t)sub_E0B4F((int16_t *)(17 * a1 + (uint8_t*)dword_1930D4), word_19999C);   /* wave 182: 0xCA12F */
  v27 = v17;
...
void sub_CA16D( int a1, int a2)
{
  ...
  v80 = a1;   /* wave 181: v80 saved by the prologue (push eax) */
  a1 = (int16_t)a1;   /* wave 181: the original reads only the low word (movsx) */
  v2 = a2;
  v4 = 17 * a1;
  ...
  if ( (int16_t)a2 == -1 )
  {
    ...
    v25 = (int16_t)sub_E0B4F((int16_t *)(17 * v80 + (uint8_t*)dword_1930D4), word_19999C);   /* wave 182: 0xCA381 */
    v68 = v25;
  ...
  else
  {
    ...
    v47 = 361 * (int16_t)v87;
    v48 = (int16_t)sub_E0B4F((int16_t *)((uint8_t*)dword_1930D4 + 17 * v80), *(char *)(v47 + (uint8_t*)dword_192B18));   /* wave 182: 0xCA5CB */
    v78 = v48;
...
//----- (000CA6A6) --------------------------------------------------------
void sub_CA6A6(_BYTE *a1, _BYTE *a2, int *a3, int a4, int a5, int a6)
{
  int (**v7)(void); // eax
...
//----- (000CA6FB) --------------------------------------------------------
int sub_CA6FB(int16_t *a1, _BYTE *a2, _BYTE *a3, int a4, int a5, int a6, int a7)
{
  int v8; // eax
  int result; // eax
...
//----- (000CA78F) --------------------------------------------------------
void sub_CA78F(_BYTE *a1, _BYTE *a2, int a3, int a4, int a5, int a6)
{
...
//----- (000CA7CF) --------------------------------------------------------
int16_t sub_CA7CF(int a1, int a2, _BYTE *a3, _BYTE *a4, int a5, int a6, int a7, int a8)
{
  int v9; // eax
  int16_t result; // ax
      ...
      do
      {
        ...
        else
        {
          ...
          *(_DWORD *)(dword_1A11AC + 27) = *(_DWORD *)(dword_1A11AC + 27);
          sub_CA6FB((int16_t *)v21, ((_BYTE *)(uintptr_t)*(uint32_t *)(v21 + 31)), ((_BYTE *)(uintptr_t)*(uint32_t *)(v21 + 35)), *(_DWORD *)(v21 + 39), v31, v22, v32);
          v23 = dword_1A11AC;
...
//----- (000CAB21) --------------------------------------------------------
void sub_CAB21(int a1, _BYTE *a2, _BYTE *a3, int *a4, int a5, int a6, int a7)
{
...
//----- (000CADA0) --------------------------------------------------------
void sub_CADA0( int a1, _WORD *a2)
{
  sub_10FE41((int)&unk_1A11F8 + 18 * word_1831C2);
  ++word_1831C2;
  sub_CADC8(a1, a2);
...
//----- (000CADC8) --------------------------------------------------------
void sub_CADC8( int a1, _WORD *a2)
{
  _WORD *v3; // ecx
  int v4; // eax
  int16_t v5; // di
...
void sub_CB23C()
{
  ...
  v31[0] = 0x131100;   /* wave 181: off_C6E5E = 0x00131100 (no relocation) */
  v31[1] = 0;
  sub_12C2C6(1);
  sub_12C2A0();
  if ( !byte_182ACA && !word_19994C )
...
//----- (000CBAD0) --------------------------------------------------------
void sub_CBAD0(int a1, int a2, int a3, int *a4)
{
  int v4; // eax
  int v5; // ebx
  int v6; // eax
...
//----- (000CC735) --------------------------------------------------------
int sub_CC735( int a1, int a2, int *a3, int a4)
{
  int v4; // edx
  int v5; // eax
  int v6; // eax
  ...
  word_1831B0 = -1;
  word_1831AC = -1;
  return v4;   /* wave 181: tail loc_C97B7 `mov     eax, edx` */
}
...
int sub_CCA1C()
{
  ...
  ServiceAudioTick_FE8BE(dword_1A1354, 0, v0, 0);
  do
  {
    v3 = dword_192ED4;
    ++v2;
  ...
  v6 = v1 + 1;
  v7 = 0;
  ServiceAudioTick_FE8BE((int)v5, v4, v3, (int16_t *)(v2 * 4));
  v8 = 0;
  v38 = v6;
  do
  {
  ...
  v12 = v7 + v6;
  v13 = 0;
  ServiceAudioTick_FE8BE((int)v11, v9, v10, (int16_t *)(v8 * 4));
  v14 = 0;
  v37 = v12;
  do
  {
  ...
  v18 = v13 + v12;
  v19 = 0;
  ServiceAudioTick_FE8BE((int)v17, v15, v16, (int16_t *)(v14 * 4));
  v20 = 0;
  v36 = v18;
  do
  {
  ...
  v24 = v19 + v18;
  v25 = 0;
  ServiceAudioTick_FE8BE((int)v23, v21, v22, (int16_t *)(v20 * 4));
  v26 = 0;
  v35 = v24;
  do
  {
  ...
  while ( v25 < 3 );
  ServiceAudioTick_FE8BE((int)v29, v27, v28, (int16_t *)(v26 * 4));
  v30 = v25 + v24;
  ...
  ServiceAudioTick_FE8BE(dword_1A12D0, v33, v32, (int16_t *)(v26 * 4));
  return sub_CC81C();
}
// 192ED4: using guessed type int dword_192ED4;
...
void sub_CCE2E()
{
  ...
  return;   /* vlna 79: JUMPOUT byl NO-OP, cil 0xCCC37 je epilog funkce */
}
...
//----- (000CDB18) --------------------------------------------------------
/* wave 182: generated by tools/compare/jumpout_gen.py - the original
   jumps into the tail at 0xCDB11 */
int sub_CDB18(void)
{
  int t1;
  int r2;
  ...
  sub_1196F7();
  t1 = (int)(intptr_t)(dseg + 0x0B29A) /* unk_18329A */;
  r2 = sub_1196B8(t1, 22);
  return r2;
}
...
int sub_CDB2A(void)
{
  ...
  sub_1196F7();
  t1 = (int)(intptr_t)(dseg + 0x0B376) /* unk_183376 */;
  r2 = sub_1196B8(t1, 7);
  return r2;
}
...
int sub_CDB3C(void)
{
  ...
  sub_1196F7();
  t1 = (int)(intptr_t)(dseg + 0x0B3BC) /* off_1833BC */;
  r2 = sub_1196B8(t1, 13);
  return r2;
}
...
int sub_CDB4E(void)
{
  ...
  sub_1196F7();
  t1 = (int)(intptr_t)(dseg + 0x0B43E) /* unk_18343E */;
  r2 = sub_1196B8(t1, 7);
  return r2;
}
...
int sub_CDB60(void)
{
  ...
  sub_1196F7();
  t1 = (int)(intptr_t)(dseg + 0x0B484) /* unk_183484 */;
  r2 = sub_1196B8(t1, 1);
  return r2;
}
...
int sub_CDBC4(void)
{
  ...
  sub_1196F7();
  t1 = (int)(intptr_t)(dseg + 0x0B4FC) /* unk_1834FC */;
  r2 = sub_1196B8(t1, 1);
  return r2;
}
...
int sub_CDBD9(void)
{
  ...
  sub_1196F7();
  t1 = (int)(intptr_t)(dseg + 0x0B506) /* unk_183506 */;
  r2 = sub_1196B8(t1, 1);
  return r2;
}
...
int sub_CDBEE(void)
{
  ...
  sub_1196F7();
  t1 = (int)(intptr_t)(dseg + 0x0B510) /* unk_183510 */;
  r2 = sub_1196B8(t1, 1);
  return r2;
}
...
int sub_CDC03(void)
{
  ...
  sub_1196F7();
  t1 = (int)(intptr_t)(dseg + 0x0B51A) /* unk_18351A */;
  r2 = sub_1196B8(t1, 1);
  return r2;
}
...
int sub_CDC18(void)
{
  ...
  sub_1196F7();
  t1 = (int)(intptr_t)(dseg + 0x0B52E) /* unk_18352E */;
  r2 = sub_1196B8(t1, 1);
  return r2;
}
...
int sub_CDC2D(void)
{
  ...
  sub_1196F7();
  t1 = (int)(intptr_t)(dseg + 0x0B538) /* unk_183538 */;
  r2 = sub_1196B8(t1, 1);
  return r2;
}
...
//----- (000CDE51) --------------------------------------------------------
unsigned int sub_CDE51( int a1, int a2, int a3, int a4, int a5, int a6,
...
//----- (000CEC99) --------------------------------------------------------
int sub_CEC99(int a1, int a2, _WORD *a3)
{
  int16_t v3; // cx
  char *v4; // eax
  _WORD *v5; // eax
...
int64_t sub_CEE50(int a1, int a2, int16_t *a3)
{
  ...
  do
  {
    ...
    LODWORD(v6) = *(int16_t *)sub_127C27((int)aColgcbtLbx, 21, dword_193174);
    v28 = (int16_t)v31 + 1;
    v22 = (int16_t)v30 + 1;
    v27 = v19;
    ...
    LODWORD(v9) = sub_127C27((int)aColgcbtLbx, 21, dword_193174);
    ...
    /* wave 182: 0xCF06D - edi = 3 after the text line */
    sub_C5D55(v24 + v21 * (*(int16_t *)(intptr_t)sub_127C27((int)aColgcbtLbx, 21, dword_193174) / v23), 446, (int16_t *)(intptr_t)v26);
    v18 = v10[5];
...
//----- (000CF26E) --------------------------------------------------------
_BOOL1 sub_CF26E( int a1, int16_t *a2, int a3, char *a4)
{
  int v5; // eax
  uint8_t *v6; // edi
  uint8_t *v7; // esi
...
//----- (000CF34C) --------------------------------------------------------
char sub_CF34C(int a1, int16_t *a2, int a3, int a4)
{
...
int sub_CFCB6(int a1, int a2, int a3, int16_t *a4)
{
  ...
  ServiceAudioTick_FE8BE(v5, v4, (int)v6, a4);
  v11 = 16;
  v12 = 0;
  ...
  ServiceAudioTick_FE8BE(v13, v12, v11, a4);
...
//----- (000D0CF2) --------------------------------------------------------
int sub_D0CF2(int a1, int a2, _DWORD *a3, int a4)
{
  uint8_t *v5; // eax
...
void sub_D0D2F(int16_t *a1)
{
  ...
  while ( 1 )
  {
    ...
    if ( (int16_t)v15 != -1 )
      v16 = sub_E109D(v15);
    ServiceAudioTick_FE8BE(v16, v15, v7, a1);
    if ( (int16_t)v15 == -1 )
      return;   /* vlna 79: JUMPOUT byl NO-OP, cil 0xCFADE je epilog funkce */
  }
}
...
//----- (000D108B) --------------------------------------------------------
int sub_D108B( int a1, int a2, int a3)
{
  int v3; // ebx
...
//----- (000D10EE) --------------------------------------------------------
void sub_D10EE( int a1, int16_t *a2)
{
  int v2; // edx
  int v3; // ecx
  int v4; // ebx
  ...
  int v64; // eax
  int16_t v65; // ax
  int (*v66)(uint8_t *, uint8_t *); // kr04_4
  int v67; // edx
  int16_t v68; // ax
  int v69; // esi
  int v70; // edx
  ...
  uint8_t *v108; // eax
  int v109; // edx
  int (*v110)(uint8_t *, uint8_t *); // ebx
  int v111; // eax
  int v112; // edx
  uint8_t *v113; // eax
  int v114; // ebx
  int (*v115)(uint8_t *, uint8_t *); // ebx
  int v116; // ebx
  uint8_t *v117; // eax
  int v118; // edx
  ...
  v119 = a1;   /* wave 181: v119 saved by the prologue (push eax) */
  a1 = (int16_t)a1;   /* wave 181: the original reads only the low word (movsx) */
  v2 = 3753 * a1;
  ...
  if ( v7 > 10 )
    v138 = 10;
  ServiceAudioTick_FE8BE(v7, v6, v4, a2);
  ...
  while ( 1 )
  {
    while ( 1 )
    {
      if ( v8 <= 0 )
      {
        ...
        if ( v139 <= 0 )
LABEL_253:
          return;   /* vlna 79: JUMPOUT byl NO-OP, cil 0xCFADF je epilog funkce */
...
LABEL_50:
        ...
        ServiceAudioTick_FE8BE(v44, v6, v8, (int16_t *)v10);
        v48 = (int)sub_D0C7F;
        v49 = 1;
        v50 = v139;
        ...
        ServiceAudioTick_FE8BE(v51, v50, v49, (int16_t *)v10);
        if ( v182 )
        {
          v54 = v142;
          if ( *(_BYTE *)(v142 + 320) == 3 )
        ...
        ServiceAudioTick_FE8BE(v54, v50, v49, (int16_t *)v10);
...
LABEL_116:
        ...
        while ( 2 )
        {
          ServiceAudioTick_FE8BE(v64, v62, v57, (int16_t *)v10);
          v62 = 6;
          v65 = sub_FE96F((int)&v122, 6);
          v66 = (int (*)(uint8_t *, uint8_t *))v48;
          v48 = v139 - 1;
          switch ( v65 )
          {
            case -1:
...
LABEL_247:
    ...
    ServiceAudioTick_FE8BE(v12, v6, v8, (int16_t *)v10);
...
int sub_D27A7(int a1, _BYTE *a2)
{
  ...
  if ( a2[282] == 3 )
    ...
    v5 = 0;
  v6 = (int16_t)sub_E0B4F((int16_t *)a1, (int)((uint8_t*)a2 - (uint8_t*)dword_197F98) / 3753);   /* wave 182: 0xD27E8 cwde / add edi, eax */
  v7 = v6 + v5;
  if ( a2[2220] )
...
//----- (000D2AA9) --------------------------------------------------------
char sub_D2AA9( int a1, int a2, int a3)
{
  char v5; // cl
  int v6; // eax
  int v7; // eax
...
void sub_D302E()
{
  ...
  while ( (int16_t)v0 > 0 )
  {
    ...
    while ( v1 > 0 )
    {
      ...
      {
        LOWORD(v3) = *v2;
        ServiceAudioTick_FE8BE((int)v2, v3, v0, (int16_t *)v1);
        if ( (int16_t)v3 == -1 )
        {
          v4 = 720 * (int16_t)v0;
  ...
  return;   /* vlna 79: JUMPOUT byl NO-OP, cil 0xD2AA2 je epilog funkce */
}
...
//----- (000D3576) --------------------------------------------------------
int16_t sub_D3576( int a1, int a2, int a3, _WORD *a4, int a5)
{
  int v6; // ecx
  uint8_t *v7; // ebx
  _BYTE *v8; // eax
...
//----- (000D383F) --------------------------------------------------------
int16_t sub_D383F( int a1, int a2, _WORD *a3)
{
  int v4; // ebx
  uint8_t *v5; // esi
  int v6; // eax
...
//----- (000D3A68) --------------------------------------------------------
char *sub_D3A68( int a1, int a2, int a3)
{
  int v5; // edx
  int v6; // eax
  int16_t i; // si
...
void sub_D3D34(int a1, int a2)
{
  ...
  memset(dword_1AA1F0, 0, 0x2D000);   /* wave 181: number, not loc_2D000 */
  ...
  ServiceAudioTick_FE8BE(v18, v4, v3, (int16_t *)a2);
  v20 = word_19999A;
  v226 = 80 * word_19999A;
  ...
  v34 = 0x28800;
  v35 = 255;
  memset(dword_1AA1B8, 255, 0x28800);   /* wave 181: number, not loc_28800 */
      ...
      if ( (v37 & 1) != 0 )
      {
        ...
        while ( v38 > 0 )
        {
          ...
          if ( (v37 & 1) != 0 )
          {
            ...
            *v40 = v35;
            ServiceAudioTick_FE8BE((int)v40, v35, (int16_t)v38, v36);
          }
        }
      }
    }
  }
  ServiceAudioTick_FE8BE(v37, v35, v34, v36);
  memset(dword_1AA1B4, 255, 36000);
  v41 = (_BYTE *)(intptr_t)0x11940;   /* wave 181: the number 72000, not loc_1193F + 1 */
  v42 = 255;
      ...
      if ( (_BYTE)v45 )
      {
        ...
        while ( v48 > 0 )
        {
          ...
          if ( (v260 & (uint8_t)v42) != 0 && v48 != v188 )
          {
            ...
            LOBYTE(v49) = v149;
            *(_BYTE *)v42 = v149;
            ServiceAudioTick_FE8BE(v49, v42, (int)v148, (int16_t *)v44);
          }
        }
      }
    }
  ...
  ServiceAudioTick_FE8BE(v57, v56, v58, (int16_t *)v44);
  v62 = 0;
...
LABEL_122:
  ...
  sub_D3BA0();
  ServiceAudioTick_FE8BE(v68, v62, v63, (int16_t *)v44);
  v69 = word_199998;
...
LABEL_136:
  ...
  ServiceAudioTick_FE8BE((int)v76, v75, v69, (int16_t *)v44);
  v78 = word_199998;
  v79 = 0;
  v80 = 58 * word_199998;
  while ( v80 > 0 )
  ...
  ServiceAudioTick_FE8BE(v80, k, v81, (int16_t *)v44);
  sub_D302E();
  ServiceAudioTick_FE8BE(v83, k, v81, (int16_t *)v44);
  sub_D3125();
  ServiceAudioTick_FE8BE(v84, k, v81, (int16_t *)v44);
  v85 = sub_DC47C(dword_1AA1D0);
  ServiceAudioTick_FE8BE(v85, k, 24016, (int16_t *)v44);
  word_1AA218 = 0;
  ...
  for ( m = 0; ; ++m )
  {
    if ( (int16_t)m >= word_1AA218 )
    {
      ...
      v100 = 0x2D000;
      v101 = 0;
      memset(dword_1AA208, 0, 0x2D000);   /* wave 181: number, not loc_2D000 */
      v198 = word_1AA218;
      n = 2 * word_1AA218;
      v242 = n;
      while ( v242 > 0 )
      {
        ...
        v199 = v104;
        ServiceAudioTick_FE8BE(v104, 11, 129 * v103, (int16_t *)v44);
      ...
      ServiceAudioTick_FE8BE(n, v101, v100, (int16_t *)v44);
      v109 = 5760;
      v110 = 0;
      ...
      ServiceAudioTick_FE8BE(v111, v110, v109, (int16_t *)v44);
      ...
      while ( (int16_t)v115 > 0 )
      {
        ...
        {
          v121 = v120 + 10;
          ServiceAudioTick_FE8BE(v119, v120, v114, v115);
          v245 = v120;
          do
          {
            ...
            if ( v146[8 * (int16_t)v115 + v252 / 2u] != -1 )
            {
              ...
              while ( v210 > 0 )
              {
                ...
                if ( v147[v246] )
                {
                  ...
                  ServiceAudioTick_FE8BE(v130, v129, v128, v115);
              ...
              while ( v152 > 0 )
              {
                ...
                if ( v152 != v209 )
                {
                  ...
                  if ( (int16_t)v134 <= 2 )
                  {
                    ServiceAudioTick_FE8BE(v134, (int16_t)v115, v133, v115);
      ...
      for ( jj = 113 * word_19999A + dword_19306C; jj > dword_19306C; jj -= 113 )
        *(_BYTE *)(jj - 61) = 0;
      return;   /* vlna 79: JUMPOUT byl NO-OP, cil 0xD2AA3 je epilog funkce */
    }
...
int sub_D6125(char *a1, int a2)
{
  ...
  v3 = sub_DDFD3(a1, a2, 0);
  v4 = v3;
  v5 = sub_DDFD3(a1, a2, 1);
  return v4 - v5;
}
