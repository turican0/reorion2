...
//----- (00093BB0) --------------------------------------------------------
void sub_93BB0(int16_t *a1, int a2)
{
  int16_t v2; // ax
  int v3; // eax
...
void sub_93C69( int a1)
{
  ...
  return;   /* vlna 79: JUMPOUT byl NO-OP, cil 0x92F4B je epilog funkce */
}
...
//----- (00093D0A) --------------------------------------------------------
int16_t sub_93D0A( int a1)
{
  char v1; // bl

  a1 = (int16_t)a1;   /* wave 181: the original reads only the low word (movsx) */
  v1 = 0;
  switch ( *(char *)(3753 * a1 + (uint8_t*)dword_197F98 + 2207) / 2 )
  {
    case 0:
      v1 = 1;
      break;
...
//----- (00093D8E) --------------------------------------------------------
char sub_93D8E( int a1, _WORD *a2, _WORD *a3)
{
  int v5; // ebx
  int16_t v6; // ax
  char result; // al
...
//----- (00093EB2) --------------------------------------------------------
void sub_93EB2(_DWORD *a1, _DWORD *a2, int a3, int a4, int a5)
{
  int v6; // ecx
  int16_t i; // bx
  ...
  *a2 = 0;
  ...
  {
    if ( v10 >= a4 )
      return;   /* vlna 79: JUMPOUT byl NO-OP, cil 0x92C1F je epilog funkce */
    v12 = 0;
    v6 = 0;
    v9 = a3;
...
void sub_9412B(int a1, int a2)
{
  ...
  sub_93D8E(a2, &v5, &v6);
  *(_DWORD *)((uint8_t*)dword_197F98 + 3753 * (int16_t)a1 + 50) -= v5;
...
void sub_942FD()
{
  ...
  ServiceAudioTick_FE8BE((int)v3, 0, v1, v2);
  for ( j = 0; j < 27; ++j )
  {
    v5 = j;
...
//----- (0009453C) --------------------------------------------------------
void sub_9453C(_BYTE *a1, int16_t *a2, int a3)
{
  int16_t v4; // ax
  int v5; // edx
  int v6; // eax
...
//----- (0009467D) --------------------------------------------------------
_BOOL1 sub_9467D(int a1, int a2, int a3)
{
  a2 = (int16_t)a2;   /* wave 181: the original reads only the low word (movsx) */
...
//----- (00094877) --------------------------------------------------------
char sub_94877( int a1)
{
  a1 = (int16_t)a1;   /* wave 181: the original reads only the low word (movsx) */
  return *(_BYTE *)(3753 * a1 + (uint8_t*)dword_197F98 + 3701);
}
// 197F98: using guessed type int (uint8_t*)dword_197F98;
...
int sub_94951(int a1)
{
  ...
  {
    v2 = *(_BYTE *)(3753 * *(char *)(59 * a1 + dword_1930DC + 58) + (uint8_t*)dword_197F98 + 2237);
...
//----- (00094BB2) --------------------------------------------------------
int sub_94BB2(int a1, int a2, int a3)
{
  int v3; // eax
  int16_t v4; // ax
...
//----- (00094C1D) --------------------------------------------------------
void sub_94C1D(int a1, int a2, int16_t *a3, int a4)
{
  int v4; // eax
  int v5; // ebx
  int16_t v6; // ax
  ...
  sub_968D1(a2, a3);
  sub_A0305();
  v4 = /* vlna 101: eax=132h, edx=0EBh, ebx=13Eh, ecx=0A9h (asm 0x94D63) */
  v4 = sub_77048(306, 235, 318, 169);
  if ( byte_199F1F )
  {
    word_19C53E = word_199838;
    word_19C540 = word_199838;
    if ( word_199838 == -1 )
      word_19C540 = *(uint8_t *)((uint8_t*)dword_1930D4 + 17 * *(int16_t *)((uint8_t*)dword_197F98 + 3753 * word_19999C + 41) + 2);
    sub_A3FE6(word_19C53E);
  }
...
LABEL_57:
    ...
    if ( byte_19C544 == -1 && !v65 )
    {
      ...
      if ( !v27 && v46 > -1 )
      {
        v28 = *(_WORD *)((uint8_t*)dword_1930D4 + 17 * sub_79C54(word_19C53E, v46));
...
//----- (000956E2) --------------------------------------------------------
int sub_956E2( int a1, int a2, int a3, int a4)
{
  int16_t v5; // di
  int v6; // eax
  char *v7; // eax
...
LABEL_8:
  ...
  else
  {
    ...
    if ( v5 >= 8 )
      ...
      v7 = (uint8_t)byte_10010[*(uint8_t *)(3753 * v5 + (uint8_t*)dword_197F98 + 38)];
...
//----- (0009636D) --------------------------------------------------------
int16_t sub_9636D( int a1, int a2, int a3)
{
  int16_t *v4; // eax
  char *v5; // edi
  int64_t v6; // rax
  ...
  {
    v7 = v16;
    v8 = ((char *)(uintptr_t)*(uint32_t *)((char *)dword_19C4CC + HIDWORD(v6)));
    do
    {
      v9 = *v8++;
      *(_BYTE *)v7 = v9;
  ...
  {
    strcpy((char *)v16, ((char *)(uintptr_t)*(uint32_t *)((char *)dword_19C4CC + HIDWORD(v6))));
    sub_8FD21(v12, 95, 32);
...
//----- (000965CE) --------------------------------------------------------
unsigned int sub_965CE(uint16_t *a1, unsigned int *a2, int a3)
{
  uint16_t v4; // cx
  int16_t v5; // bx
  int v6; // eax
...
//----- (00096737) --------------------------------------------------------
void sub_96737(uint16_t *a1, int *a2, int a3, _WORD *a4, _WORD *a5)
{
  int16_t v6; // bx
  int v7; // edi
  int16_t v8; // di
...
void sub_968D1(int a1, int16_t *a2)
{
  ...
  sub_12DAA4(100, 100);
  v2 = 17 * *(int16_t *)(3753 * word_19999C + (uint8_t*)dword_197F98 + 41);
  LOWORD(v2) = *(uint8_t *)((uint8_t*)dword_1930D4 + v2 + 2);
  v24 = v2;
  ...
  v3 = 0;
  dword_19C4C8 = (int)(_DWORD*)sub_110D3C((PoolMemType*)dword_192ED4, 3953);
  while ( 1 )
  {
    ...
    *(_WORD *)(v5 + 3) = *(char *)(v4 + 55);
    ...
    if ( (int16_t)++v3 >= 67 )
    {
      dword_193114 = (int)(_DWORD*)sub_110D3C((PoolMemType*)dword_192ED4, 268);
      dword_1930EC = (int)(_DWORD*)sub_110D3C((PoolMemType*)dword_192ED4, 268);
      LOWORD(v6) = sub_92E72();
      ServiceAudioTick_FE8BE(v6, 268, v3, a2);
      ...
      ServiceAudioTick_FE8BE(dword_193160, 5, v8, a2);
      ...
      ServiceAudioTick_FE8BE(dword_1930E0, 14, v9, a2);
      ...
      ServiceAudioTick_FE8BE(dword_1930E8, 141, v10, a2);
      ...
      ServiceAudioTick_FE8BE(dword_19311C, 142, v12, a2);
      v13 = 88;
      dword_193108 = (int)(_DWORD*)sub_110D3C((PoolMemType*)dword_192ED4, 48);
      sub_93DF7();
      sub_942FD();
      v14 = 0;
      v23 = dword_192ED4;
...
//----- (00096E95) --------------------------------------------------------
int sub_96E95(int a1, int a2, int a3, int a4, _BYTE *a5, _WORD *a6, _WORD *a7)
{
  int result; // eax
  int v8; // ebx
  int16_t j; // si
...
//----- (00097041) --------------------------------------------------------
int sub_97041( int a1, int a2, int16_t *a3, int16_t *a4)
{
  int16_t v4; // dx
  int v5; // esi
  int16_t i; // ax
...
//----- (0009718F) --------------------------------------------------------
int sub_9718F( int a1, int a2, int a3, int a4)
{
  int16_t v5; // si
  int16_t v6; // dx
  _BYTE *v7; // eax
...
//----- (000972EE) --------------------------------------------------------
_BOOL1 sub_972EE( int a1, int a2, int a3)
{
  _BOOL1 result; // al
...
//----- (000973CC) --------------------------------------------------------
_BOOL1 sub_973CC( int a1, int a2)
{
  a2 = (int16_t)a2;   /* wave 181: the original reads only the low word (movsx) */
...
//----- (00097529) --------------------------------------------------------
char sub_97529( int a1, int a2, int a3)
{
...
//----- (00097565) --------------------------------------------------------
char *sub_97565(char *a1, int a2, int a3)
{
  a3 = (int16_t)a3;   /* wave 181: the original reads only the low word (movsx) */
...
//----- (00097588) --------------------------------------------------------
int16_t *sub_97588( int a1, int a2)
{
  int v3; // ecx
  int v4; // eax
  int16_t v5; // ax
...
int sub_9781D( int a1)
{
    ...
    return 0;   /* 0x97850 */
  {
    ...
    if ( *(_WORD *)(v3 + 3690) )
      ...
      v4 = sub_64395();
    LOWORD(v5) = v4 + 1;
    if ( *(_BYTE *)((uint8_t*)dword_197F98 + 3753 * a1 + 2227) )
      LOWORD(v5) = v5 + 5;
    if ( *(_BYTE *)(3753 * a1 + (uint8_t*)dword_197F98 + 2226) )
      LOWORD(v5) = v5 - 10;
    for ( i = 0; i < 67; ++i )
    {
      v11 = 59 * i;
...
void sub_979A0( int a1)
{
  ...
  v3 = 0;
  if ( *(char *)(v2 + 58) != -1 )
    v3 = *(_BYTE *)((uint8_t*)dword_197F98 + 3753 * *(char *)(v2 + 58) + 2237) != 0;
  v4 = v3;
  v5 = 59 * a1;
...
//----- (00097A29) --------------------------------------------------------
int sub_97A29( int a1, int a2)
{
  a1 = (int16_t)a1;   /* wave 181: the original reads only the low word (movsx) */
  a2 = (int16_t)a2;   /* wave 181: the original reads only the low word (movsx) */
  return sub_97A2D(a1, a2);
}
// 97A2D: using guessed type int sub_97A2D(_DWORD, _DWORD);
...
int sub_97B2D( int a1)
{
  ...
  v5 = 0;
  v6 = 3753 * v1 + (uint8_t*)dword_197F98;
  v7 = 0;
  if ( *(_BYTE *)(v6 + 2227) )
  {
    LOWORD(v4) = v4 + 10;
...
//----- (00097C64) --------------------------------------------------------
int sub_97C64( int a1, int a2, int a3)
{
  int v4; // eax
  int v5; // eax
  int v6; // edi
...
//----- (00097D59) --------------------------------------------------------
void sub_97D59( int a1, int16_t *a2, char *a3)
{
  int v4; // edx
  int v5; // eax
  int16_t v6; // bx
...
LABEL_30:
  return;   /* vlna 79: JUMPOUT byl NO-OP, cil 0x92E6C je epilog funkce */
}
...
int16_t sub_98062( int a1)
{
  ...
  {
    if ( v3 <= *(_DWORD *)((uint8_t*)dword_197F98 + 3753 * word_19999C + 50) )
    {
      sub_92D72(v1);
      return v5;
    }
...
//----- (000980DB) --------------------------------------------------------
int sub_980DB( int a1, int a2, _WORD *a3)
{
  int16_t v5; // ax
  int16_t v6; // dx
  int16_t v7; // ax
  ...
  v10 = 3753 * a1;
  v11 = v10 + (uint8_t*)dword_197F98;
  *a3 = 0;
  if ( sub_E412B(v11, 0x2Fu) )
  {
    sub_E4204(v10 + (uint8_t*)dword_197F98, 0x2Fu, v10);
...
//----- (000981D1) --------------------------------------------------------
char sub_981D1(char *a1, int a2, int a3)
{
  uint16_t v4; // ax
  char result; // al
  char *v6; // edi
...
//----- (00098282) --------------------------------------------------------
void sub_98282(int a1, int a2, int a3)
{
...
//----- (000982B6) --------------------------------------------------------
void sub_982B6(int a1, int a2, int a3, _WORD *a4)
{
  int16_t v5; // si
  unsigned int v6; // ebx
  ...
  while ( v5 )
  {
    ...
    v8 = (int16_t)v7[v6];
    v9 = 3753 * (int16_t)a1;
    sub_E4204(v9 + (uint8_t*)dword_197F98, v8, a1);
    *(_WORD *)(v10 + 2 * (int16_t)(*a4)++) = v8;
    --v11;
    --v5;
    v7[v6] = v7[(int16_t)v11];
  }
  return;   /* vlna 79: JUMPOUT byl NO-OP, cil 0x97152 je epilog funkce */
}
...
//----- (00098363) --------------------------------------------------------
char sub_98363( int a1, int a2, int16_t *a3)
{
  int16_t i; // cx
  int v4; // eax
  ...
  *a3 = 0;
  for ( i = 0; i < 212; ++i )
  {
    ...
    if ( (_WORD)v4 == 74 )
    {
      LOBYTE(v4) = sub_E412B((uint8_t*)dword_197F98 + 3753 * a1, i);
      if ( (_BYTE)v4 )
      {
        v4 = *a3;
        *(_WORD *)(a2 + 2 * v4) = i;
...
void sub_98489()
{
  ...
  {
    if ( *(_BYTE *)(3753 * j + (uint8_t*)dword_197F98 + 2226) )
    {
      v7 = v22[(int16_t)v5];
      v8 = v7;
      ++v5;
  ...
  {
    if ( !*(_BYTE *)((uint8_t*)dword_197F98 + 3753 * m + 2226) )
    {
      v16 = 0;
      do
      {
...
void sub_987FB(int a1, int a2, int a3)
{
  ...
  if ( byte_199F1F )
  {
    ...
    if ( v63 )
      sub_98CEB((uint8_t*)dword_197F98 + 3753 * word_19999C, 59 * v57 + dword_1930DC, 113 * (int16_t)v60 + dword_19306C, v30);
  }
  else
  {
    v62 = a2;
    ...
    if ( v3 == word_19999C )
    {
      ...
      if ( v18 )
        sub_98DAD((uint8_t*)dword_197F98 + 3753 * word_19999C, dword_1930DC + 59 * v57, 129 * (int16_t)v62 + dword_197F9C, v10);
    }
    else
    {
      v4 = v58;
  ...
  return;   /* vlna 79: JUMPOUT byl NO-OP, cil 0x97739 je epilog funkce */
}
...
int sub_98C23(int a1, int a2, uint8_t* a3)
{
  ...
  v4 = sub_98E4B(((uint8_t*)a1 - (uint8_t*)dword_197F98) / 3753, (a2 - dword_1930DC) / 59, (a3 - dword_197F9C) / 129);
...
char sub_98C87(int a1, int a2, uint8_t* a3)
{
  ...
  v4 = sub_98F42(((uint8_t*)a1 - (uint8_t*)dword_197F98) / 3753, (a2 - dword_1930DC) / 59, (a3 - dword_19306C) / 113);
...
//----- (00098E4B) --------------------------------------------------------
char sub_98E4B( int a1, int a2, int a3)
{
  int16_t v4; // si
  _BOOL1 v5; // dl
  int16_t v6; // ax
  ...
  v11 = *(uint8_t *)(17 * *(int16_t *)(3753 * a1 + (uint8_t*)dword_197F98 + 41) + (uint8_t*)dword_1930D4 + 2);
  if ( v6 != -1 )
    v5 = sub_97287(v6, v4);
  if ( dword_19C4C8 )
  {
...
//----- (00098F42) --------------------------------------------------------
char sub_98F42( int a1, int a2, int a3)
{
  int16_t v3; // cx
  int16_t v4; // si
  int16_t v5; // di
  ...
  v3 = a3;
  LOBYTE(a3) = 5;
  v4 = *(uint8_t *)((uint8_t*)dword_1930D4 + 17 * *(int16_t *)((uint8_t*)dword_197F98 + 3753 * a1 + 41) + 2);
  if ( dword_19C4C8 )
...
void sub_98FEE(int16_t *a1)
{
  ...
  while ( 1 )
  {
    ...
    sub_124E36();
    sub_124C08();
    v14 = (uint8_t*)dword_197F98 + 3753 * word_19999C + 1;
    v1 = sub_7A990(0x11Cu);
    sprintf(v18, v1, v14);
...
LABEL_5:
      ...
      {
        v11 = 3753 * i;
        if ( *(char *)(v11 + (uint8_t*)dword_197F98 + 1441) == v3 )
        {
          strcpy(v17, sub_7A990(0x120u));
          v15 = v11 + (uint8_t*)dword_197F98 + 1;
          v12 = sub_97588(v3, 0);
...
LABEL_22:
      ...
      a1 = (int16_t *)v17;
      v16 = (uint8_t*)dword_197F98 + 3753 * word_19999C + 1;
      v13 = sub_97588(v3, 1);
      sprintf(v18, v17, v13, v16);
      if ( (uint16_t)sub_7A25F(&byte_199F28, (int)v18, 1) )
      {
        v19 = 1;
        *(_BYTE *)(3753 * word_19999C + (uint8_t*)dword_197F98 + 1441) = v3;
      }
    }
    if ( v19 )
    {
...
void sub_99223( int a1, int a2)
{
  ...
  if ( a1 == 47 )
  {
    ...
    v5 = 3753 * a2;
    if ( sub_E412B(v5 + (uint8_t*)dword_197F98, v4) )
      sub_E4204(v5 + (uint8_t*)dword_197F98, v4, v5);
  }
  else
  {
    for ( i = 0; i < 3; ++i )
    {
      if ( *(_BYTE *)(i + 59 * a1 + dword_1930DC + 46) )
      {
        ...
        v10 = 3753 * a2;
        if ( sub_E412B(v10 + (uint8_t*)dword_197F98, v7) )
          sub_E4204(v10 + (uint8_t*)dword_197F98, v7, v7);
      }
    }
  }
  if ( !*(_BYTE *)(59 * a1 + dword_1930DC + 35) )
...
LABEL_11:
    if ( ++v3 >= 67 )
      return v2;   /* wave 181: tail loc_947FE `mov     eax, ecx` */
  }
}
...
//----- (00099522) --------------------------------------------------------
int sub_99522(int result, int a2)
{
  *(_WORD *)(result + 36) = 1;
  *(_WORD *)(result + 28) = a2;
  return result;
...
//----- (0009953F) --------------------------------------------------------
unsigned int sub_9953F(_WORD *a1, int a2)
{
  unsigned int result; // eax
...
//----- (0009958B) --------------------------------------------------------
unsigned int sub_9958B(_WORD *a1, int a2)
{
  unsigned int result; // eax
  ...
  while ( 1 )
  {
    ...
    if ( ++v19 >= 8 )
    {
      ...
      *(_WORD *)(v32 + 18) = *(_WORD *)(v31 + 126);
      return;   /* vlna 79: JUMPOUT byl NO-OP, cil 0x99A69 je epilog funkce */
    }
  }
}
...
int sub_99A6F()
{
  dword_19C5A0 = (int)(_DWORD*)sub_110D3C((PoolMemType*)dword_192ED4, 10080);
  memset(dword_19C5A0, -1, 10080);
  dword_19C598 = (int)(_DWORD*)sub_110D3C((PoolMemType*)dword_192ED4, 277);
  memset(dword_19C598, 0, 277);
  dword_19C5A4 = (int)(_DWORD*)sub_110D3C((PoolMemType*)dword_192ED4, 4000);
...
void sub_99AFA()
{
  ...
  sub_9CFA8();
  return;   /* vlna 79: JUMPOUT byl NO-OP, cil 0x99A68 je epilog funkce */
}
...
//----- (00099F38) --------------------------------------------------------
char sub_99F38(char *a1, _BYTE *a2, unsigned int a3, _BYTE *a4)
{
  char *v4; // edi
  int16_t v5; // dx
  char v6; // bl
...
LABEL_18:
  ...
  LOBYTE(a1) = 6 * *(_BYTE *)((uint8_t*)dword_197F98 + 3753 * (int16_t)a1 + 38) - 49;
  *a4 = (_BYTE)a1;
  if ( a3 )
  {
    if ( a3 <= 1u )
...
//----- (0009A04B) --------------------------------------------------------
char sub_9A04B(char *a1, _BYTE *a2, unsigned int a3)
{
  _BYTE v4[4]; // [esp+0h] [ebp-4h] BYREF

  a1 = (char *)(int16_t)a1;
  if ( (int16_t)a1 != -1 )
    a1 = (char *)*(char *)(361 * (int16_t)a1 + (uint8_t*)dword_192B18);
...
void sub_9A2BA(int16_t *a1)
{
  ...
  v3 = 0;
  v4 = -1;
  v5 = (int16_t *)(_DWORD*)sub_110D3C((PoolMemType*)dword_192ED4, 10080);
  v6 = memset(v5, -1, 10080);
  *a1 = 0;
  while ( v3 < word_1999A2 )
  {
    ServiceAudioTick_FE8BE(v6, v4, v2, v5);
    v4 = (uint8_t*)dword_1930D4;
    v6 = (uint8_t*)dword_1930D4 + 17 * v3;
...
//----- (0009A4F1) --------------------------------------------------------
_WORD *sub_9A4F1( int a1, _WORD *a2, _WORD *a3)
{
  int16_t *v5; // eax
  int16_t v6; // ax
  int16_t v7; // ax
...
int sub_9A5E8( int a1)
{
  ...
  for ( i = 0; i < *(int16_t *)(dword_1975C4 + 8) && v1 == -1; ++i )
  {
    ...
    if ( *(uint8_t *)(17 * v4[5] + (uint8_t*)dword_1930D4 + 2) == a1 )
    {
      if ( v4[8] >= v4[9] )
        v1 = v4[8];
      else
...
void sub_9A6A0(int16_t *a1)
{
  ...
  do
  {
    ...
    *(_DWORD *)(dword_19C594 + 4 * v2) = v3;
    ServiceAudioTick_FE8BE(v4, v1, v2, a1);
  }
  while ( (int16_t)v1 < 50 );
}
// 19C594: using guessed type int dword_19C594;
...
int sub_9A6C9()
{
  ...
  v0 = sub_126B42(
         (int)off_1822FA,
         (int16_t)(*(uint8_t *)((uint8_t*)dword_197F98 + 3753 * word_19999C + 38) + 76),
         dword_192ED4);
  result = dword_19C598;
...
int sub_9A709(int16_t *a1)
{
  ...
  *(_DWORD *)(dword_19C598 + 12) = v7;
  ServiceAudioTick_FE8BE(v8, (int)v7, v6, a1);
  ...
  *(_DWORD *)(dword_19C598 + 28) = v13;
  ServiceAudioTick_FE8BE(v14, (int)v13, v12, a1);
  ...
  *(_DWORD *)(dword_19C598 + 48) = v20;
  ServiceAudioTick_FE8BE(v21, (int)v20, v19, a1);
  v22 = 15;
  *(_DWORD *)(dword_19C598 + 44) = sub_126B42((int)off_1822FA, 14, dword_192ED4);
  ...
  do
  {
    ...
    ServiceAudioTick_FE8BE(v27, v24, v26, a1);
  }
  while ( v23 < 11 );
  sub_111499(dword_192ED4);
  *(_DWORD *)(dword_19C598 + 52) = sub_126B42(
                                     (int)off_1822FA,
                                     (int16_t)(*(uint8_t *)(3753 * word_19999C + (uint8_t*)dword_197F98 + 38) + 76),
                                     dword_192ED4);
  sub_1318D4(0, 255);
  sub_13AAC1();
...
//----- (0009A98A) --------------------------------------------------------
_BOOL1 sub_9A98A( int a1, int a2)
{
  a1 = (int16_t)a1;   /* wave 181: the original reads only the low word (movsx) */
  a2 = (int16_t)a2;   /* wave 181: the original reads only the low word (movsx) */
  return (int16_t)sub_9AF07(a2, *(uint8_t *)((uint8_t*)dword_1930D4 + 17 * a1 + 6)) > 0;
}
// 1930D4: using guessed type int (uint8_t*)dword_1930D4;


//----- (0009A9AC) --------------------------------------------------------
_BOOL1 sub_9A9AC( int a1)
{
  char v1; // dl
  _BOOL1 result; // al

  a1 = (int16_t)a1;   /* wave 181: the original reads only the low word (movsx) */
  v1 = sub_79E32(word_19999C, *(uint8_t *)((uint8_t*)dword_1930D4 + 17 * a1 + 2));
...
//----- (0009A9E2) --------------------------------------------------------
_BOOL1 sub_9A9E2( int a1)
{
  a1 = (int16_t)a1;   /* wave 181: the original reads only the low word (movsx) */
  return *(_BYTE *)(17 * a1 + (uint8_t*)dword_1930D4 + 11) == 0;
}
// 1930D4: using guessed type int (uint8_t*)dword_1930D4;


//----- (0009A9F8) --------------------------------------------------------
_BOOL1 sub_9A9F8( int a1)
{
  int v1; // eax
  int16_t v2; // dx

  a1 = (int16_t)a1;   /* wave 181: the original reads only the low word (movsx) */
  v1 = *(int16_t *)((uint8_t*)dword_1930D4 + 17 * a1);
  v2 = -1;
  if ( v1 != -1 )
    v2 = *(char *)(361 * v1 + (uint8_t*)dword_192B18);
...
int sub_9AA2E( int a1)
{
  ...
  {
    if ( *(uint8_t *)((uint8_t*)dword_1930D4 + 17 * *(int16_t *)(dword_19C5A0 + 28 * (int16_t)i + 10) + 2) == a1 )
      v2 = i;
  }
  return v2;
}
...
int sub_9AA83( int a1)
{
  ...
  return v2;   /* wave 181: tail loc_9AA7C `mov     eax, edx` */
}
...
//----- (0009AAC1) --------------------------------------------------------
char sub_9AAC1( int a1)
{
  a1 = (int16_t)a1;   /* wave 181: the original reads only the low word (movsx) */
  return sub_FF68A(dword_19306C + 113 * *(uint8_t *)((uint8_t*)dword_1930D4 + 17 * a1 + 2), word_19999C);
}
// 19306C: using guessed type int dword_19306C;
// 1930D4: using guessed type int (uint8_t*)dword_1930D4;
// 19999C: using guessed type int16_t word_19999C;
...
_BOOL1 sub_9AAED( int a1)
{
  ...
  a1 = (int16_t)a1;   /* wave 181: the original reads only the low word (movsx) */
  v1 = 0;
  v10 = *(uint8_t *)((uint8_t*)dword_1930D4 + 17 * a1 + 2);
  for ( i = 0; i < 5 && !v1; ++i )
  {
    v3 = *(int16_t *)(dword_19306C + 113 * v10 + 2 * i + 74);
    if ( v3 > -1 )
    {
      v4 = *(int16_t *)(17 * v3 + (uint8_t*)dword_1930D4);
      if ( v4 > -1 )
        v1 = *(char *)(361 * v4 + (uint8_t*)dword_192B18) != word_19999C;
    }
  }
  if ( !v1 )
  {
...
//----- (0009ABEC) --------------------------------------------------------
_BOOL1 sub_9ABEC( int a1)
{
  a1 = (int16_t)a1;   /* wave 181: the original reads only the low word (movsx) */
  return *(_BYTE *)((uint8_t*)dword_1930D4 + 17 * a1 + 10) <= 1u;
}
// 1930D4: using guessed type int (uint8_t*)dword_1930D4;


//----- (0009AC0D) --------------------------------------------------------
char sub_9AC0D( int a1)
{
  int v1; // eax
  ...
  if ( v1 <= -1 )
    ...
    return *(_BYTE *)(361 * v1 + (uint8_t*)dword_192B18 + 6);
}
// 192B18: using guessed type int (uint8_t*)dword_192B18;
// 1930D4: using guessed type int (uint8_t*)dword_1930D4;
...
//----- (0009AC79) --------------------------------------------------------
char sub_9AC79(int a1, int a2, int a3, int a4, int a5)
{
  int16_t v5; // dx
  int16_t v6; // ax
  int v7; // esi
  ...
  v25 = a2;   /* wave 181: v25 saved by the prologue (push edx) */
...
//----- (0009B04D) --------------------------------------------------------
int sub_9B04D( int a1, int a2, _WORD *a3)
{
  int v4; // edx
  int v5; // eax
  int v6; // edx
  ...
  for ( i = 0; ; ++i )
  {
    ...
    if ( (int16_t)v8 == -1 )
      continue;
    v10 = 17 * (int16_t)v8 + (uint8_t*)dword_1930D4;
...
void sub_9B2C7(int a1)
{
  ...
  v10 = *(uint8_t *)((uint8_t*)dword_1930D4 + 17 * (int16_t)a1 + 2);
  v11 = v9;
  if ( v9 != v10 && (_WORD)v57 == 1 && *(char *)(dword_19C5A0 + 28 * (int16_t)v59 + 26) > 0
    || (_WORD)v57 == 4 && *(char *)(dword_19C5A0 + 28 * (int16_t)v59 + 27) > 0 )
  {
    v42 = dword_19306C + 113 * *(uint8_t *)((uint8_t*)dword_1930D4 + 17 * (int16_t)a1 + 2);
...
void sub_9B7F1( int a1, int a2)
{
  ...
  while ( 1 )
  {
    ...
    if ( ++v5 >= 72 )
      return;   /* vlna 79: JUMPOUT byl NO-OP, cil 0x9ABE6 je epilog funkce */
  }
}
...
char sub_9BB40()
{
  ...
  {
    LOBYTE(v1) = sub_A44FC(*(uint8_t *)(17 * i + (uint8_t*)dword_1930D4 + 2), word_19999C);
    if ( (_BYTE)v1 )
...
int16_t sub_9BBED()
{
  ...
  /* wave 182: comparators from the asm (ecx at 0x9BC12 / 0x9BC1E / 0x9BC2A):
     0 = climate (+8), 1 = minerals (+4), 2 = size (+0) */
  result = word_182306;
  if ( (uint16_t)word_182306 > 2u )
    return result;
  v1 = dword_1975C4;
  qsort((void *)(intptr_t)dword_19C5A0, *(int16_t *)(v1 + 8), 28,
        word_182306 == 0 ? sub_9CCFF : word_182306 == 1 ? sub_9CD17 : sub_9CD0C);
  return result;
}
// 182306: using guessed type int16_t word_182306;
// 1975C4: using guessed type int dword_1975C4;
...
int sub_9BF1C( int a1)
{
  ...
  for ( i = 0; i < *(int16_t *)(dword_1975C4 + 8) && v2 == -1; ++i )
  {
    if ( *(uint8_t *)((uint8_t*)dword_1930D4 + 17 * *(int16_t *)(28 * i + dword_19C5A0 + 10) + 2) == a1 )
      v2 = i;
  }
  return v2;   /* wave 181: tail loc_9AA7C `mov     eax, edx` */
}
...
void sub_9BF70()
{
  ...
  while ( 1 )
  {
    ...
    if ( (int16_t)v69 >= (int16_t)v60 - *(int16_t *)(dword_1975C4 + 12) )
      return;   /* vlna 79: JUMPOUT byl NO-OP, cil 0x9B7DF je epilog funkce */
...
LABEL_40:
  ...
  v6 = 17 * (int16_t)v4;
  v7 = v6 + (uint8_t*)dword_1930D4;
  LOWORD(v6) = *(uint8_t *)(v6 + (uint8_t*)dword_1930D4 + 2);
  v64 = v6;
  LOWORD(v6) = v3[3];
  LOWORD(v3) = v3[4];
  v59 = v3;
...
LABEL_12:
    v9 = 17 * (int16_t)v66;
    sub_9A04B((char *)*(int16_t *)(v9 + (uint8_t*)dword_1930D4), v53, v8);
    v70 = *(int16_t *)(v9 + (uint8_t*)dword_1930D4) != -1;
    ...
    if ( v5 > 0 && v11 )
    {
      ...
      if ( v12 && *(char *)((uint8_t*)dword_1930D4 + 17 * (int16_t)v66 + 15) == v5 )
      {
...
LABEL_27:
    ...
    if ( v70 )
    {
      v21 = (char *)(3753 * *(char *)(361 * *(int16_t *)(17 * v54 + (uint8_t*)dword_1930D4) + (uint8_t*)dword_192B18)
...
LABEL_33:
        ...
        v63 = v38 + v42 + 4;
        v43 = v68 + 386;
        sub_1210FD(v68 + 386, v38, dword_192BE0[*(uint8_t *)(17 * (int16_t)v66 + (uint8_t*)dword_1930D4 + 5)]);
        sub_120BB5(1, (int)v53);
...
LABEL_56:
    return;   /* vlna 79: JUMPOUT byl NO-OP, cil 0x9B7E5 je epilog funkce */
  }
...
LABEL_7:
  ...
  if ( v3 > -1 )
    v0 = 6 * *(uint8_t *)((uint8_t*)dword_197F98 + 3753 * v3 + 38) + 212;
...
{
  return *(const int16_t *)((const char *)a2 + 8) - *(const int16_t *)((const char *)a1 + 8);
}
...
{
  return *(const int16_t *)a2 - *(const int16_t *)a1;
}


//----- (0009CD17) --------------------------------------------------------
/* wave 182: loc_9CD17 - the minerals comparator of sub_9BBED (no proc in IDA) */
int sub_9CD17(const void *a1, const void *a2)
{
  return *(const int16_t *)((const char *)a2 + 4) - *(const int16_t *)((const char *)a1 + 4);
}
...
int16_t sub_9CD24( int16_t a1, int16_t a2)
{
  ...
  if ( v0 != -1 )
  {
    ...
    if ( (int16_t)v6 == -1 )
    {
      ...
      if ( (int16_t)v6 != -1 )
        goto LABEL_20;
      v6 = 17 * *(int16_t *)(3753 * word_19999C + (uint8_t*)dword_197F98 + 41);
      LOWORD(v6) = *(uint8_t *)((uint8_t*)dword_1930D4 + v6 + 2);
    }
    v25 = v6;
LABEL_20:
    if ( (int16_t)v25 != -1 )
...
int sub_9D0C6()
{
  ...
  sub_9A125();
  sub_9CAA0();
  sub_A0226((int16_t *)dword_1975C4, (void (*)(_DWORD))sub_9A1F0);
  sub_9BF70();
  if ( word_1999BC > -1 )
    sub_9C600();
...
void sub_9D252()
{
  ...
  *(_BYTE *)(v4 + 26) = 1;
  v8 = 0;
  dword_19C594 = (int)(_DWORD*)sub_110D3C((PoolMemType*)v7, 200);
  do
  {
    v9 = (int16_t)v8;
    ...
    *(_DWORD *)(dword_19C594 + 4 * v9) = v10;
    ServiceAudioTick_FE8BE(v11, v9, (int)v8, 0);
  }
  while ( (int16_t)v8 < 50 );
...
int sub_9D816( int a1)
{
  ...
  for ( i = 0; i < 8; ++i )
  {
    if ( i != a1 && *(_BYTE *)(3753 * a1 + (uint8_t*)dword_197F98 + i + 1551) == 1 )
      v8[i] = 2;
    if ( *(_WORD *)(2 * i + (uint8_t*)dword_197F98 + 3753 * a1 + 498) )
      v8[i] = 5;
  }
  ...
  *(_WORD *)(dword_19C7C0 + 138) = v4;
  while ( v5 < *(int16_t *)(dword_19C7C0 + 138) )
  {
    ...
    {
      ++v2;
      *(_BYTE *)(v5 + dword_19C7C0 + 142) = *(_BYTE *)(3753 * v6 + (uint8_t*)dword_197F98 + 37);
    }
    ++v5;
  }
...
int sub_9D977( int a1)
{
  ...
  *(_WORD *)(dword_19C7C0 + 176) = v6;
  v9 = *(_WORD *)(3753 * a1 + (uint8_t*)dword_197F98 + 514);
...
//----- (0009DB21) --------------------------------------------------------
char sub_9DB21( int a1)
{
  a1 = (int16_t)a1;   /* wave 181: the original reads only the low word (movsx) */
  return *(_BYTE *)(3753 * a1 + (uint8_t*)dword_197F98 + 496);
}
// 197F98: using guessed type int (uint8_t*)dword_197F98;


//----- (0009DB39) --------------------------------------------------------
char sub_9DB39( int a1)
{
  a1 = (int16_t)a1;   /* wave 181: the original reads only the low word (movsx) */
  return *(_BYTE *)(3753 * a1 + (uint8_t*)dword_197F98 + 495);
}
// 197F98: using guessed type int (uint8_t*)dword_197F98;


//----- (0009DB51) --------------------------------------------------------
int sub_9DB51( int a1)
{
  uint16_t v2; // dx
...
// 9E207: using guessed type int sub_9E207(_DWORD, _DWORD, _DWORD, _DWORD);
// 19C7C0: using guessed type int dword_19C7C0;
...
void sub_9DC76()
{
  ...
  return;   /* vlna 79: JUMPOUT byl NO-OP, cil 0x9D946 je epilog funkce */
}
  ...
  while ( (int16_t)v27 < word_199998 )
  {
    ...
    if ( *(_WORD *)(v20 + (uint8_t*)dword_197F98 + v21 + 498) )
    {
      ...
      sprintf(
        v16,
        "%d.%d",
        *(uint16_t *)(v20 + v21 + (uint8_t*)dword_197F98 + 498) / 10,
        *(uint16_t *)(v20 + v21 + (uint8_t*)dword_197F98 + 498) % 10);
      v17 = (int16_t)v23;
      v8 = v22 + v7 / 2;
      ...
      sub_120DED(2, 1);
      v31 = 1;
      if ( (int16_t)sub_12066F(v19 + (uint8_t*)dword_197F98 + 1) <= v7 )
      {
        v12 = v19 + (uint8_t*)dword_197F98 + 1;
        v13 = v25;
        v14 = sub_122259();
...
int sub_9E207(_DWORD _p0, _DWORD _p1, _DWORD _p2, _DWORD _p3)
{
...
void sub_9E27A()
{
  ...
  sub_9DC76();
  return;   /* vlna 79: JUMPOUT byl NO-OP, cil 0x9DB1B je epilog funkce */
}
// 9E3A8: control flows out of bounds to 9DB1B
// 9E207: using guessed type int sub_9E207(_DWORD, _DWORD, _DWORD, _DWORD);
// 9E68B: using guessed type int sub_9E68B(_DWORD);
// 1265F2: using guessed type int64_t sprintf(_DWORD, char *, ...);
// 19C7C0: using guessed type int dword_19C7C0;
...
/* wave 182: generated by tools/compare/jumpout_gen.py - the original
   jumps into the tail at 0x9DC6D */
int sub_9E3AD(void)
{
  int r1;
  int t2;
  ...
  r1 = sub_7A990(347);
  t2 = (int16_t)(*(int16_t *)(intptr_t)((int)(intptr_t)dword_19C7C0 + 162));
  r3 = sub_9E207(t2, r1, 0, 0);
  return r3;
}
...
//----- (0009E3D1) --------------------------------------------------------
int sub_9E3D1( int a1, int a2, int a3)
{
  int16_t v3; // si
  int v4; // eax
  int v5; // ecx
  ...
  for ( i = 0; i < a3; ++i )
  {
    ...
    {
      if ( a1 )
        sub_BB53E(*(uint8_t *)(dword_19C7C0 + i + 142));
      else
...
//----- (0009E64A) --------------------------------------------------------
/* wave 182: generated by tools/compare/jumpout_gen.py - the original
   jumps into the tail at 0x9DBD3 */
int sub_9E64A(void)
{
  int t1;
  int r2;

  t1 = (int16_t)(*(int16_t *)(intptr_t)((int)(intptr_t)dword_19C7C0 + 158));
  r2 = sub_9E3D1(0, 4, t1);
  return r2;
}
...
int sub_9E664(void)
{
  ...
  r1 = sub_7A990(349);
  t2 = (int16_t)(*(int16_t *)(intptr_t)((int)(intptr_t)dword_19C7C0 + 168));
  r3 = sub_9E207(t2, r1, 0, 360);
  return r3;
}
...
//----- (0009E735) --------------------------------------------------------
int sub_9E735( int a1)
{
  uint16_t v1; // bx

  a1 = (int16_t)a1;   /* wave 181: the original reads only the low word (movsx) */
  v1 = *(_WORD *)((uint8_t*)dword_197F98 + 3753 * a1 + 514);
...
int sub_9E84C( int a1)
{
  ...
  *(_WORD *)(dword_19C7C0 + 136) = 0;
  ...
  {
    if ( *(_WORD *)(3753 * a1 + (uint8_t*)dword_197F98 + 2 * v2 + 498) )
    {
      v1 += 50;
...
int sub_9E8C7( int a1)
{
  ...
  for ( i = 0; i < word_199996; ++i )
  {
    v4 = (char *)(361 * i + (uint8_t*)dword_192B18);
    if ( *v4 == a1 )
      v2 += (uint8_t)v4[10];
  }
  *(_WORD *)(dword_19C7C0 + 160) = v2;
  return v2;   /* wave 181: tail loc_9E89C `mov     eax, ebx` */
}
...
//----- (0009E90B) --------------------------------------------------------
int sub_9E90B( int a1, _WORD *a2, _WORD *a3)
{
  int16_t v4; // ax
  int result; // eax
  ...
  *a3 = 0;
  do
  {
    if ( *(_BYTE *)(3753 * a1 + (uint8_t*)dword_197F98 + v4 + 196) == 3 )
      ++*a2;
    ++v4;
  }
  while ( v4 < 83 );
  ...
  do
  {
    if ( *(_BYTE *)((int16_t)result + 3753 * a1 + (uint8_t*)dword_197F98 + 540) )
      ++*a3;
    ++result;
  }
...
//----- (0009EA3B) --------------------------------------------------------
int16_t sub_9EA3B( int a1, int16_t *a2)
{
  int v3; // ecx
  char v4; // al
  int16_t v5; // dx
  ...
  sub_1196F7();
  v3 = 0;
  if ( !sub_9F4AD() )   /* wave 182: 0x9EA4C test al, al */
    sub_9F540();
  ...
  *(_BYTE *)(dword_19C7C0 + 187) = -1;
  ...
  sub_9D816(v5);
  v7 = dword_19C7C0 + 107;
  sub_8F1C4((void (*)(int, int))sub_9E27A, (_BYTE *)(dword_19C7C0 + 107), 12);
...
int sub_9EB42()
{
  ...
  *(_DWORD *)(dword_19C7C0 + 8) = v1;
  ...
  v2 = sub_12DAA4(50, 50);
  dword_19C150 = (int)(_DWORD*)sub_110D3C((PoolMemType*)dword_192ED4, v2);
...
//----- (0009EC32) --------------------------------------------------------
char sub_9EC32( int a1)
{
  a1 = (int16_t)a1;   /* wave 181: the original reads only the low word (movsx) */
  return *(_BYTE *)(3753 * a1 + (uint8_t*)dword_197F98 + 497);
}
// 197F98: using guessed type int (uint8_t*)dword_197F98;
...
//----- (0009ED88) --------------------------------------------------------
int16_t sub_9ED88( int a1)
{
  sub_1112EC(dword_192ED4, 293);
  dword_19C7C0 = (int)(_DWORD*)sub_110D3C((PoolMemType*)dword_192ED4, 293);
  memset(dword_19C7C0, 0, 293);
  *(_BYTE *)(dword_19C7C0 + 104) = a1;
  sub_9D977(a1);
...
//----- (0009F286) --------------------------------------------------------
void sub_9F286( int a1, int a2, int a3, int a4)
{
  int v4; // ebx
  char v5; // al
  int16_t v6; // ax
  ...
  if ( sub_9F4AD() )   /* wave 182: 0x9F31F test al, al */
    v6 = word_19C5FC;
  else
    v6 = 0;
  if ( v6 != 130 )
...
int8_t sub_9F4AD()
{
  ...
  if ( v0 )
  {
    ...
    sub_9FC27((int)v2);
    return 1;   /* wave 182: 0x9F4FE mov al, 1 */
  }
  return 0;   /* wave 182: 0x9F4CA xor al, al */
}
