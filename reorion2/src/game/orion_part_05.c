...
//----- (000643A0) --------------------------------------------------------
/* wave 181: rewritten from the asm. The two "%2d " loops count in dx; Hex-Rays
   had merged the counter with sprintf's return and the loops never ended
   (word_18FF78 overflowed -> __fastfail on TURN). The second sprintf really
   overwrites the first line (edi is reset to word_18FF78). Returns al:
   0 when sub_A1762 finds no ship (0x644D0), 1 otherwise (0x64596). */
char sub_643A0(int a1)
{
  int16_t v1; // ax (cwde after sub_22F5C)
  int16_t i; // dx
  int16_t v8; // si
  int16_t v11; // cx
  int v12; // edx
  uint8_t *v16; // eax
  _BYTE v21[100]; // [ebp-B8h] BYREF
  char v22[20]; // [ebp-54h] BYREF
  char v23[20]; // [ebp-40h] BYREF
  _BYTE v24[16]; // [ebp-2Ch] BYREF
  int16_t v25[2]; // [ebp-1Ch] BYREF
  int v26; // [ebp-18h]
  int v27; // [ebp-14h]
  int v28; // [ebp-10h]
  int v29; // [ebp-Ch]
  ...
  v29 = sub_645A4(v1);
  v30 = 0;
  sprintf((char *)&word_18FF78, aShipsBySize);
  for ( i = 0; i < 9; ++i )
  {
    sprintf(v23, "%2d ", word_19918C[i]);
    strcat((char *)&word_18FF78, v23);
  }
  sprintf((char *)&word_18FF78, aShipsDeployedB);
  for ( i = 0; i < 9; ++i )
  {
    sprintf(v22, "%2d ", word_19919E[i]);
    strcat((char *)&word_18FF78, v22);
  }
  v26 = v29 + 500;
  while ( !v31 )
  {
    ...
    if ( (int16_t)v30 )
    {
      v11 = (int16_t)sub_100010(8, v21, (int16_t)v27, (int16_t)v28);
    }
    else
    {
      v11 = (int16_t)sub_A1762((int16_t)v29, 8, v21, 1);
      if ( v11 == -1 )
        return 0;
      v12 = 129 * v11;
      v27 = *(int16_t *)(dword_197F9C + v12 + 103);
      v28 = *(int16_t *)(dword_197F9C + v12 + 105);
    }
    if ( v11 == -1 )
    {
      v31 = 1;
    ...
    else
    {
      ++word_19919E[v8];
      v25[0] = v11;
      sub_FF799(v25, (int16_t)v29, v24);
      if ( v24[5] )
      {
        sub_FFD08(v25, (int16_t)v29, v24);
        v16 = dword_197F9C + 129 * v11;
        *(_BYTE *)(v16 + 100) = 1;
        *(_WORD *)(v16 + 101) = v26;
        *(_BYTE *)(v16 + 113) = 2;
        *(_WORD *)(v16 + 114) = word_17D17E + 1;
      }
    }
...
void sub_6603E(int16_t *a1)
{
  ...
  v1 = 0;
  word_19995E = 0;
  sub_1112EC((uint8_t*)dword_192EE8, 29);
  v2 = 479;
  dword_1975C4 = (int)(_DWORD*)sub_110D3C(dword_192EE8, 29);
  ...
  if ( (uint16_t)word_199860 >= 2u )
  {
    if ( (uint16_t)word_199860 <= 2u )
    {
      *(_WORD *)(dword_1975C4 + 8) = 6;
      ...
      {
        if ( result
          && *(_BYTE *)(3753 * word_19999C + (uint8_t*)dword_197F98 + *(int16_t *)((char *)&word_17F6A7 + 59 * result) + 279) != 3 )
        {
    ...
    else if ( word_199860 == 8 )
    {
      *(_WORD *)(dword_1975C4 + 8) = 6;
      for ( result = 0; result < *(int16_t *)(dword_1975C4 + 8); ++result )
      {
        if ( result && *(_BYTE *)((uint8_t*)dword_197F98 + 3753 * word_19999C + word_17FDF2[11 * result] + 279) != 3 )
        {
          word_18B0E0[result] = -1;
        }
        else
  ...
  *(_BYTE *)(dword_1927A8 + 250) = 1;
  while ( 1 )
  {
    ...
    *(_BYTE *)(v0 + dword_1927A8 + 250) = 0;
    if ( v1 > -1
      && *(_BYTE *)(word_17F80D[14 * v1] + (uint8_t*)dword_197F98 + 3753 * word_19999C + 279) == 3
  ...
  *(_WORD *)(dword_1975C4 + 8) = 1;
  while ( v2 < 39 )
  {
    ...
    if ( *(int16_t *)(dword_1975C4 + 8) >= 40 )
      break;
    if ( *(_BYTE *)(*(int16_t *)((char *)&word_17EEE6 + 47 * v2) + (uint8_t*)dword_197F98 + 3753 * word_19999C + 279) == 3 )
    {
...
LABEL_37:
  ...
  *(_WORD *)(v25 + 291) = *v24;
  dword_1975C4 = 0;
  sub_1113CC((uint8_t*)dword_192EE8, (int)v11);
  word_199A08 = 3;
...
void sub_6908A(int a1)
{
  ...
  if ( word_19B972 > -1 )
  {
    ...
    do
    {
      if ( v3 == 13 )
      {
        if ( byte_17F80F[28 * v6] == 1 && *(_BYTE *)(3753 * word_19999C + (uint8_t*)dword_197F98 + 338) == 3 )
        {
          ++v2;
          sub_66870(13);
          *(_BYTE *)(a1 + 13) = 1;
...
LABEL_26:
    ...
    *(_BYTE *)(dword_1927A8 + v4 + 250) = 0;
    ...
    if ( *(_BYTE *)(v26 + 3753 * a1 + (uint8_t*)dword_197F98 + 279) == 3 )
      break;
LABEL_24:
    ++v4;
  }
...
void sub_69583()
{
  ...
  *(_WORD *)v5 = v7 - v4 / 2;
  ...
  while ( 1 )
  {
    ...
    {
      dword_1975C4 = 0;
      sub_1113CC((uint8_t*)dword_192EE8, SHIDWORD(v9));
      sub_119281();
      sub_11C2F0();
      word_199A08 = 3;
...
int sub_6A7C8( int a1, int a2)
{
  ...
  *(_WORD *)(dword_1927A8 + 229) = v6;
  ...
  if ( *(_BYTE *)(3753 * word_19999C + (uint8_t*)dword_197F98 + 368) == 3 )
    v7 = 125 * v7 / 100;
  ...
  *(_WORD *)(v18 + 248) = 0;
  ...
  {
    if ( (uint16_t)sub_1276F0((uint8_t*)dword_197F98 + 3753 * a1 + 806 + 99 * a2 + 23, i) )
    {
      v23 = v21++;
...
char sub_6AE96( int a1)
{
  ...
  v2 = 3753 * word_19999C;
  v3 = *(uint8_t *)((uint8_t*)dword_197F98 + v2 + 37);
  if ( a1 == word_199866 )
  {
    v2 = dword_1927A8;
...
int sub_6B577(int a1, int a2)
{
  ...
  *(_WORD *)(v3 + 229) = v5;
  ...
  if ( *(_BYTE *)((uint8_t*)dword_197F98 + 3753 * word_19999C + 368) == 3 )
    v6 = 125 * v6 / 100;
  v7 = dword_1927A8;
  ...
  *(_WORD *)(v7 + 49) = *(uint8_t *)(a2 + 22);
  v9 = sub_5709F(v23);   /* vlna 150: asm `mov edx, eax` */
  v8 = 0;
  *(_WORD *)(dword_1927A8 + 47) = v9;
  do
  {
...
int16_t sub_6B949()
{
  ...
  if ( !byte_199EF1 )
    return dword_19B998;
  sub_6A6A1((int)v1);
  return sub_D108B(word_19999C, 99 * word_199838 + (uint8_t*)dword_197F98 + 3753 * word_19999C + 806, (int)v1);
}
// 197F98: using guessed type int (uint8_t*)dword_197F98;
    ...
    do
    {
      if ( v13 == word_192750[(int16_t)a3] )
      {
        if ( (uint8_t)byte_19B9AC[(int16_t)a3] <= 0xF0u )
        {
          a1 = dword_1927A8;
          v7 = *(int16_t *)(dword_1927A8 + 231) % 8;
          v23 = *(uint8_t *)((uint8_t*)dword_197F98 + 3753 * word_19999C + 37);
...
char sub_6C897(int a1, int a2, int a3, char *a4)
{
  ...
  v4 = 48 * a1 + 8 * a2;
  sub_1112EC((uint8_t*)dword_192EE8, v4);
  v5 = (char *)sub_126C37((int)aShipnameLbx, 0, (uint8_t*)dword_192EE8, (int16_t)(a3 + v4), 1u, 16);
  sub_1113CC((uint8_t*)dword_192EE8, 0);
  strcpy(a4, v5);
  return result;
}
// 192EE8: using guessed type int (uint8_t*)dword_192EE8;
...
void sub_6C98D(int a1, int a2, int a3, int16_t *a4)
{
  ...
  ServiceAudioTick_FE8BE(dword_1927E4, 5, v7, (int16_t *)6);
  do
  {
  ...
  ServiceAudioTick_FE8BE((int)v18, v17, v16, (int16_t *)v8);
  ...
  ServiceAudioTick_FE8BE((int)v36, v35, v34, (int16_t *)v8);
  ...
  ServiceAudioTick_FE8BE((int)v42, v41, v40, (int16_t *)v8);
  v43 = 0;
  ...
  while ( (int16_t)v49 < 5 );
  ServiceAudioTick_FE8BE(v53, v52, v50, (int16_t *)v8);
  v54 = 0;
  do
  {
  ...
  ServiceAudioTick_FE8BE((int)v79, v78, v77, (int16_t *)v8);
  ...
  dword_1927A8 = (int)(_DWORD*)sub_110CEE(dword_192EE8, 293);
  dword_192694 = (int)(_DWORD*)sub_110D3C(dword_192EE8, 240);
  v83 = 0;
  sub_6F23C(v91);
  do
  {
    v84 = (int16_t *)v83;
    v85 = (uint8_t*)dword_192EE8;
    v86 = sub_126C37((int)v91, 1, (uint8_t*)dword_192EE8, v83++, 1u, 100);
    dword_19269C[(_DWORD)v84] = (int)v86;
    ServiceAudioTick_FE8BE((int)v86, 1, v85, v84);
  }
  while ( v83 < 39 );
  for ( i = 0; i < 40; ++i )
  {
    v88 = (int16_t *)i;
    v89 = (uint8_t*)dword_192EE8;
    v90 = sub_126C37((int)v91, 3, (uint8_t*)dword_192EE8, i, 1u, 100);
...
LABEL_2:
  ...
  while ( 1 )
  {
    ...
    if ( v6 )
    {
      if ( v6 < 75 )
      {
        if ( *(_BYTE *)(v6 + 3753 * a1 + (uint8_t*)dword_197F98 + 196) == 3 )
        {
          v3 = 23 * v6;
          ++v5;
          goto LABEL_2;
      ...
      {
        v7 = (int16_t)(v6 - 75);
        LOWORD(v7) = *(uint8_t *)((uint8_t*)dword_197F98 + 3753 * a1 + v7 + 540);
        v5 += v7;
      }
    }
    v4 = 1;
...
char sub_6D167()
{
  ...
  while ( 1 )
  {
    if ( *(int16_t *)(dword_1927A8 + 2 * v1 + 181) > 0 )
      ++v0;
    if ( ++v1 >= 8 )
      return v0;   /* wave 181: tail loc_6D18B `mov     al, dl` */
  }
}
  ...
  switch ( v2 )
  {
    ...
    case 245:
      ...
      if ( word_199A10 == 25 )
      {
        ...
        v5 = sub_77B28(*(_WORD *)((uint8_t*)dword_192B18 + 361 * *(int16_t *)(17 * v4 + (uint8_t*)dword_1930D4) + 2));
        v3 = 1;
        sprintf(v10, (char *)v5);
      }
      break;
...
void sub_6E42E()
{
  ...
  for ( i = 0; i < 212 && !v0; ++i )
  {
    if ( *(_BYTE *)((uint8_t*)dword_197F98 + 3753 * word_19999C + i + 279) == 3 && sub_654DD(i) == 9 )
    {
      v8 = 0;
      for ( j = 1; j < 39 && !v8; ++j )
      {
...
_BOOL2 sub_6E571()
{
  ...
  for ( i = 0; i < 212 && !v0; ++i )
  {
    if ( *(_BYTE *)(i + (uint8_t*)dword_197F98 + 3753 * word_19999C + 279) == 3 && sub_654DD(i) == 3 )
    {
      v2 = sub_6E69E(i, 3u);
...
void sub_6EA48( int a1, int a2)
{
  ...
  v2 = 3753 * a1;
  v3 = 99 * a2;
  strcpy((char *)(v2 + (uint8_t*)dword_197F98 + 806 + v3), (char *)dword_1927A8);
  v4 = (_BYTE *)dword_1927A8;
  v5 = v2 + (uint8_t*)dword_197F98;
  ...
  *(_BYTE *)(v3 + v5 + 828) = v4[49];
  ...
  {
    v7 = (int16_t)v6++;
    *(_BYTE *)(v7 + (uint8_t*)dword_197F98 + 3753 * a1 + 99 * a2 + 829) = 0;
  }
  while ( (int16_t)v6 < 5 );
  v8 = 0;
  while ( 1 )
  {
    ...
    if ( *(int16_t *)(v9 + 181) > 0 )
    {
      v3 = (uint8_t*)dword_197F98 + 3753 * a1 + 806;
    ...
    if ( ++v8 >= 8 )
    {
      ...
      do
      {
        ...
        v16 = 99 * a2;
        v11 = v16 + v17 + (uint8_t*)dword_197F98;
        v12 = (int16_t)v18;
...
void sub_6FF08()
{
  ...
  if ( v0 == word_199A06 )
  {
    ...
    v9 = sub_7836A(word_1999B8);   /* vlna 158 */
...
_BOOL1 sub_7022D( int a1)
{
  ...
  v2 = a1 > -1 && *(int16_t *)((uint8_t*)dword_1930D4 + 17 * a1) == -1;
...
void sub_70875()
{
  ...
  {
    v3 = sub_7836A(word_1999B8);   /* vlna 158 */
    v4 = sub_71465(v3);
    v5 = v4;
    sub_71A37(v4);
    v6 = (v5 + 2) / 3;
...
int16_t sub_711E6( int a1)
{
  ...
  if ( byte_199BC6 )
  {
    ...
    v_ecx = *(int16_t *)(dword_1932B0 + 2);   /* asm `mov cx, [eax+2]` */
...
char sub_714A1( int a1)
{
  ...
  if ( a1 > -1 )
  {
    v2 = (int16_t *)(17 * a1 + (uint8_t*)dword_1930D4);
    if ( *((_BYTE *)v2 + 4) == 3 )
    {
      v3 = *v2;
      if ( v3 == -1 || *(_BYTE *)((uint8_t*)dword_192B18 + 361 * v3 + 6) )
        return 1;
    }
  }
  return v1;
