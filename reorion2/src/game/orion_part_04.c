...
//----- (00058807) --------------------------------------------------------
void sub_58807(_DWORD *a1, int a2, int a3)
{
  _DWORD *v6; // edx
  int i; // ebx
  int v8; // edx
...
//----- (0005EF4B) --------------------------------------------------------
void sub_5EF4B( int a1, int a2, int a3)
{
  int v3; // edi
  int v4; // eax
  int v5; // esi
...
//----- (0006147F) --------------------------------------------------------
void sub_6147F( int a1, int a2, int16_t *a3, int a4, int a5)
{
  int16_t v5; // dx
  int v6; // edi
  int v7; // eax
