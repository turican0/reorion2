...
// poradi okna. V portu to ale zavisi na tom, jak si globaly posklad�
...
void sub_10DC12(int a1, int a2, int a3, int16_t *a4)
{
  ...
  {
    v6 = (int16_t)v4;
    v7 = *(_BYTE *)(3753 * v5 + (uint8_t*)dword_197F98 + (int16_t)v4++ + 540);
    byte_1AD59C[v6] = v7;
  }
  while ( (int16_t)v4 < 8 );
  v8 = word_19999C;
  ...
  do
  {
    v10 = 3753 * v8 + (uint8_t*)dword_197F98;
    v11 = (int16_t)v9++;
    ++*(_BYTE *)(v10 + v11 + 540);
  }
  while ( (int16_t)v9 < 8 );
  ...
  if ( v64 == 1 )
  {
    ...
    ServiceAudioTick_FE8BE((int)v46, 15, v12, (int16_t *)byte_1AD5CC);
    ...
    ServiceAudioTick_FE8BE((int)v50, 19, v14, (int16_t *)byte_1AD5CC);
    ...
    ServiceAudioTick_FE8BE((int)v53, 22, v15, (int16_t *)byte_1AD5CC);
  ...
  else
  {
    ...
    ServiceAudioTick_FE8BE((int)v46, 1, v18, (int16_t *)byte_1AD5CC);
    ...
    ServiceAudioTick_FE8BE((int)v49, 4, v20, (int16_t *)byte_1AD5CC);
    ...
    ServiceAudioTick_FE8BE((int)v52, 6, v22, (int16_t *)byte_1AD5CC);
  ...
  ServiceAudioTick_FE8BE((int)v55, v17, v23, (int16_t *)byte_1AD5CC);
  ...
  while ( v27 < 8u );
  ServiceAudioTick_FE8BE(v30, SHIDWORD(v30), v29, (int16_t *)v24);
  if ( !(_WORD)v61 )
  {
LABEL_63:
    ...
    do
    {
      v43 = (int16_t)v41 + 3753 * v42 + (uint8_t*)dword_197F98;
  ...
  v30 = sprintf(v45, "SR_R%x_SC.LBX", *(uint8_t *)((uint8_t*)dword_197F98 + 3753 * word_19999C + 37));
  ServiceAudioTick_FE8BE(v30, SHIDWORD(v30), 639, (int16_t *)v24);
  if ( !v64 )
  {
...
LABEL_19:
  ServiceAudioTick_FE8BE(v30, SHIDWORD(v30), v32, (int16_t *)v24);
  if ( !v64 )
  {
    sub_124D41();
    sub_128C32(0, 0, 639, 479, 0);
    if ( *(_BYTE *)((uint8_t*)dword_197F98 + 3753 * word_19999C + 37) == 7 )
      v34 = 17;
    else
      v34 = 0;
    sub_12D6B2(v34);
...
int sub_10E563(int result, int a2)
{
  ...
  if ( result && *(_BYTE *)(result + 6) && *(_WORD *)(result + 81) )
  {
    ...
    v7 = a2 + 1;
    if ( *(_BYTE *)((uint8_t*)dword_197F98 + 3753 * word_19999C + 2229) == 1
      || *(_WORD *)(result + 81) == 55
      || *(_WORD *)(result + 81) == 57
      || *(_WORD *)(result + 81) == 29
      || *(_WORD *)(result + 81) == 22
...
int16_t *sub_10E6C7(int a1, int a2, int a3, int16_t *a4)
{
  ...
  if ( v58 == 1 )
  {
    ...
    ServiceAudioTick_FE8BE((int)v43, 25, v10, a4);
  ...
  else
  {
    ...
    ServiceAudioTick_FE8BE((int)v43, 11, v14, a4);
...
int sub_10F884( int a1)
{
  ...
  {
    v3 = (int16_t)result;
    v4 = *(_BYTE *)((int16_t)result++ + (uint8_t*)dword_197F98 + 3753 * a1 + 540);
    byte_1AD59C[v3] = v4;
  }
...
char sub_10F8B7( int a1)
{
  ...
  do
  {
    v3 = (int16_t)v2 + 3753 * a1 + (uint8_t*)dword_197F98;
...
int sub_10F919(int result, int a2)
{
  if ( (int16_t)result >= 75 )
  {
    ...
    ++*(_BYTE *)(3753 * a2 + (uint8_t*)dword_197F98 + (int16_t)result + 465);
  }
  return result;
}
// 197F98: using guessed type int (uint8_t*)dword_197F98;
...
char *sub_114177()
{
  ...
  {
    *PORT_PTR32(uint16_t *, (char *)off_184480 + 55 * (int16_t)v4 + 32) = *(_WORD *)((char *)off_184480 + 55 * (int16_t)v4 + 28);
         ...
         || *(_WORD *)((char *)off_184480 + 55 * (int16_t)v4 + 18) )
  {
      ...
      && (dword_18448E >> 16 == -1 || *(int *)((char *)off_184480 + 55 * (dword_18448E >> 16) + 6) >> 16 != 12) )
    {
      ...
      *PORT_PTR32(uint16_t *, (char *)off_184480 + 55 * (int16_t)v4 + 36) = (sub_123ABA() - v1)
                                                               / (*(int *)((char *)off_184480 + 55 * (int16_t)v4 + 26) >> 16);
      v2 = *(int *)((char *)off_184480 + 55 * (int16_t)v4) >> 16;
      *PORT_PTR32(uint16_t *, (char *)off_184480 + 55 * (int16_t)v4 + 40) = (sub_123AE7() - v2)
...
int sub_1156E2( int a1)
{
  ...
  result = v11;
  *PORT_PTR32(uint16_t *, (char *)off_184480 + 55 * a1 + 32) = v11;
  return result;
}
// 184480: using guessed type _UNKNOWN *off_184480;
// 1B3E14: using guessed type int dword_1B3E14;
...
char *sub_115994( int a1)
{
  ...
  result = v6;
  *PORT_PTR32(uint16_t *, (char *)off_184480 + 55 * a1 + 32) = (_WORD)v6;
  return result;
}
// 184480: using guessed type _UNKNOWN *off_184480;
    ...
    while ( v5 < word_1B3E0E )
    {
      ...
      switch ( *(_WORD *)((char *)off_184480 + 55 * v5 + 8) )
      {
        case 0:
          ...
          if ( *(_DWORD *)((char *)off_184480 + 55 * v5 + 24) && *PORT_PTR32(uint8_t *, (char *)off_184480 + 55 * v5 + 24) )
            goto LABEL_46;
          goto LABEL_114;
        case 1:
          if ( *PORT_PTR32(uint16_t *, (char *)off_184480 + 55 * v5 + 32) )
          {
        ...
        case 2:
          ...
          goto LABEL_114;
        case 3:
          if ( *PORT_PTR32(uint16_t *, (char *)off_184480 + 55 * v5 + 32) == *(_WORD *)((char *)off_184480 + 55 * v5 + 28) )
          {
            if ( *(_WORD *)((char *)off_184480 + 55 * v5 + 36) )
            {
              sub_12B753(*(_DWORD *)((char *)off_184480 + 55 * v5 + 44), 1);
...
LABEL_46:
        ...
        case 4:
          ...
          goto LABEL_114;
        case 6:
          v13 = *PORT_PTR32(uint16_t *, (char *)off_184480 + 55 * v5 + 32);
          ...
          *PORT_PTR32(uint16_t *, (char *)off_184480 + 55 * v5 + 32) = v13;
          goto LABEL_114;
        case 0xA:
          sub_120BB5(*(int *)((char *)off_184480 + 55 * v5 + 8) >> 16, *(_DWORD *)((char *)off_184480 + 55 * v5 + 12));
          v12 = sub_122286() / 2;
