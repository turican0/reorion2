...
//----- (0010278D) --------------------------------------------------------
int sub_10278D( int a1, int a2, int a3)
{
  int v3; // ecx
  int result; // eax
...
//----- (0010283D) --------------------------------------------------------
int sub_10283D( int a1)
{
  int result; // eax

  result = (uint8_t*)dword_197F98 + 3753 * word_19999C + word_19999C;
  *(_BYTE *)(result + 3671) &= 0xC0u;
...
void sub_102872()
{
  ...
  v0 = (uint8_t*)dword_197F98 + 3753 * word_19999C + word_19999C;
  *(_BYTE *)(v0 + 3671) &= 0x3Fu;
  JUMPOUT(0x102868);
}
...
int sub_102994()
{
  ...
  v0 = (uint8_t*)dword_197F98 + 3753 * word_19999C;
  v1 = v0 + word_19999C;
...
void sub_1029FA(int a1)
{
  ...
  *(_WORD *)(*(_DWORD *)a1 + 2 * *(int16_t *)(a1 + 8)) = 0;
  if ( !*(_WORD *)(a1 + 8) )
LABEL_70:
    return;   /* vlna 79: JUMPOUT byl NO-OP, cil 0x102421 je epilog funkce */
  v2 = sub_113F8C();
...
//----- (00102D7D) --------------------------------------------------------
char *sub_102D7D(char *result, int a2)
{
  int16_t i; // dx
...
//----- (00102D94) --------------------------------------------------------
int16_t sub_102D94( int result, int a2)
{
  int16_t i; // dx
...
//----- (00102DAB) --------------------------------------------------------
void sub_102DAB( int a1, int a2, int a3, int a4, int a5, unsigned int a6, int a7)
{
...
//----- (001031B8) --------------------------------------------------------
void sub_1031B8(int a1, int a2, int a3)
{
  JUMPOUT(0x10318F);
}
...
void sub_103200(int a1, int a2, int a3)
{
  ...
  return;   /* vlna 79: JUMPOUT byl NO-OP, cil 0x103235 je epilog funkce */
}
...
// 103259: using guessed type _DWORD sub_103259(_DWORD);
...
int sub_103313(int a1)
{
  ...
  do
  {
    ...
    v13 = v5;
    ServiceAudioTick_FE8BE(v5, 1, 4096, (int16_t *)v5);
...
//----- (001035AF) --------------------------------------------------------
void sub_1035AF( int a1, int a2, int a3, int a4, unsigned int a5, int a6, int a7)
{
  uint16_t v9; // cx
  uint16_t v10; // ax
  int v11; // ecx
  ...
  return;   /* vlna 79: JUMPOUT byl NO-OP, cil 0x102F0A je epilog funkce */
}
...
// mir� o 2 bajty vedle. Podle asm volani sub_1035AF jsou to
...
_DWORD sub_103933( int _p0, _DWORD _p1)
{
...
/* wave 182: generated by tools/compare/jumpout_gen.py - the original
   jumps into the tail at 0x1039E7 */
int sub_103A2D(void)
{
  int t1;
  int r2;
  ...
  sub_1196F7();
  t1 = (int)(intptr_t)(dseg + 0x0B718) /* unk_183718 */;
  r2 = sub_1196B8(t1, 3);
  return r2;
}
...
int sub_103A3F(void)
{
  ...
  sub_1196F7();
  t1 = (int)(intptr_t)(dseg + 0x0B736) /* unk_183736 */;
  r2 = sub_1196B8(t1, 3);
  return r2;
}
...
int sub_103A51(void)
{
  ...
  sub_1196F7();
  t1 = (int)(intptr_t)(dseg + 0x0B754) /* unk_183754 */;
  r2 = sub_1196B8(t1, 2);
  return r2;
}
...
int sub_103A63(void)
{
  ...
  sub_1196F7();
  t1 = (int)(intptr_t)(dseg + 0x0B768) /* unk_183768 */;
  r2 = sub_1196B8(t1, 2);
  return r2;
}
...
int sub_103A78(void)
{
  ...
  sub_1196F7();
  t1 = (int)(intptr_t)(dseg + 0x0B77C) /* unk_18377C */;
  r2 = sub_1196B8(t1, 2);
  return r2;
}
...
int sub_103A8D(void)
{
  ...
  sub_1196F7();
  t1 = (int)(intptr_t)(dseg + 0x0B790) /* unk_183790 */;
  r2 = sub_1196B8(t1, 2);
  return r2;
}
...
int sub_103AA2(void)
{
  ...
  sub_1196F7();
  t1 = (int)(intptr_t)(dseg + 0x0B7A4) /* unk_1837A4 */;
  r2 = sub_1196B8(t1, 8);
  return r2;
}
...
int sub_103AB7(void)
{
  ...
  sub_1196F7();
  t1 = (int)(intptr_t)(dseg + 0x0B7F4) /* unk_1837F4 */;
  r2 = sub_1196B8(t1, 1);
  return r2;
}
...
//----- (00103CD6) --------------------------------------------------------
int sub_103CD6( int a1, int a2, int a3)
{
  int v3; // eax
...
// 13E22A: using guessed type int toupper(_DWORD, _DWORD);
// 13E238: using guessed type int tolower(_DWORD);
// 1ACEFC: using guessed type int dword_1ACEFC;
// 1ACF00: using guessed type int dword_1ACF00;
// 1ACF08: using guessed type int dword_1ACF08;
// 1ACF0C: using guessed type int dword_1ACF0C;
...
//----- (001043B0) --------------------------------------------------------
char sub_1043B0( unsigned int a1, int a2, int a3, int a4)
{
  int v4; // eax
  _BYTE *v5; // edx
  _BYTE *v6; // edx
  ...
  if ( a1 >= 0x17u )
  {
    switch ( a1 )
    {
      ...
      case 0x1Au:
        v15 = dword_1ACF14;
        ++*(_DWORD *)(dword_1ACF14 + 2);
        v16 = *(_BYTE *)(intptr_t)*(uint32_t *)(v15 + 2) - 48;
      ...
      case 0x1Bu:
        v14 = dword_1ACF14;
        ++*(_DWORD *)(dword_1ACF14 + 2);
        *(_BYTE *)(dword_1ACF00 + 4) = 32 * (*(_BYTE *)(intptr_t)*(uint32_t *)(v14 + 2) - 48);
        return a2;
      case 0x1Cu:
        sub_104BD7();
        return a2;
...
char sub_10465A()
{
  ...
  *(_DWORD *)(dword_1ACF14 + 2) = v1 + 1;
  ...
  if ( !*(_WORD *)(v0 + 41) )
    goto LABEL_9;
  v4 = ((_BYTE *)(uintptr_t)*(uint32_t *)(v0 + 43));
  *(_WORD *)(v0 + 41) = 0;
  while ( 1 )
  {
    *(_DWORD *)(v0 + 2) = v4;
...
int sub_1046FF()
{
  ...
  v0 = dword_1ACF14;
  ++*(_DWORD *)(dword_1ACF14 + 2);
  v1 = *(_BYTE *)(intptr_t)*(uint32_t *)(v0 + 2) - 48;
  if ( *(int16_t *)(dword_1ACF08 + 12) > 0 )
  {
...
char sub_104A24()
{
  ...
  v0 = dword_1ACF14;
  ++*(_DWORD *)(dword_1ACF14 + 2);
  LOBYTE(v0) = *(_BYTE *)(intptr_t)*(uint32_t *)(v0 + 2) & 0xF;
...
char sub_104BD7()
{
  ...
  v0 = dword_1ACF14;
  ++*(_DWORD *)(dword_1ACF14 + 2);
  v1 = *(_BYTE *)(intptr_t)*(uint32_t *)(v0 + 2);
  if ( v1 == 54 )
  {
...
char sub_104C2C()
{
  ...
  ++*(_DWORD *)(dword_1ACF14 + 2);
  byte_1ACF74 = 0;
  v1 = ((char *)(uintptr_t)*(uint32_t *)(v0 + 2));
  v2 = *v1;
  if ( sub_10544B(&v15) )
    v3 = sub_104F6A(v15);
  else
...
//----- (00104F6A) --------------------------------------------------------
int sub_104F6A( unsigned int a1)
{
  int result; // eax
...
//----- (00104FEB) --------------------------------------------------------
char sub_104FEB( unsigned int a1, int a2)
{
  char result; // al
  char v3; // bl
  int v4; // eax
...
void sub_105089(int a1, int a2, int a3)
{
  ...
  v3 = dword_1ACF14;
  ++*(_DWORD *)(dword_1ACF14 + 2);
  v4 = *(_BYTE *)(intptr_t)*(uint32_t *)(v3 + 2);
  if ( aFirst[v4] == 48 )
    v5 = 1;
  else
...
//----- (0010541B) --------------------------------------------------------
int sub_10541B( unsigned int a1, int a2, int a3)
{
  int result; // eax
...
char sub_10544B(uint16_t *a1)
{
  ...
  v2 = dword_1ACF14;
  ++*(_DWORD *)(dword_1ACF14 + 2);
  v3 = ((uint8_t *)(uintptr_t)*(uint32_t *)(v2 + 2));
  v4 = v3;
  while ( *v3 == 32 )
    ++v3;
  if ( *v3 )
...
LABEL_4:
  v2 = aFrtxyshvpimoc;
  v3 = toupper(*(uint8_t *)(intptr_t)*(uint32_t *)(dword_1ACF14 + 2), v1);
  v4 = v3;
  do
  {
    v5 = *v2;
...
LABEL_94:
    ...
    *(_DWORD *)(dword_1ACF14 + 2) = v1;
    if ( *v1 != 44 )
    {
      if ( v4 == 79 )
      {
        v1 = (_BYTE *)((int (*)())(void*)sub_103D53)(*(_BYTE *)(v21 + 39), *(_DWORD *)(v21 + 16), *(_BYTE *)(v21 + 20));
        *(_DWORD *)(dword_1ACF14 + 2) = v1;
      }
      goto LABEL_4;
    }
...
// 103D53: using guessed type _DWORD sub_103D53(char, _DWORD, char);
// 133EF4: using guessed type int qsort(_DWORD, _DWORD, _DWORD, _DWORD);
// 13E22A: using guessed type int toupper(_DWORD, _DWORD);
// 1838F7: using guessed type int16_t word_1838F7;
// 1838F9: using guessed type int16_t word_1838F9[10];
...
//----- (00105A2C) --------------------------------------------------------
char sub_105A2C( int a1, unsigned int a2, int a3, int a4, int a5)
{
  uint8_t *v5; // eax
  int16_t v6; // cx
  int v7; // ebx
...
//----- (00105BA0) --------------------------------------------------------
char sub_105BA0(int a1, int a2, int a3, int a4, int a5)
{
  char result; // al
...
//----- (00105BFB) --------------------------------------------------------
char sub_105BFB( int a1, int a2, int a3, int a4, int a5)
{
  int v5; // eax
  int v6; // edx
...
//----- (00105CA4) --------------------------------------------------------
char sub_105CA4(int a1, int a2, int a3, int a4, int a5)
{
  int v5; // eax
  int v6; // edx
  int v7; // ebx
...
//----- (00105D74) --------------------------------------------------------
char sub_105D74(int a1, int a2, int a3, int a4, int a5)
{
  int v5; // esi
...
//----- (00105DAC) --------------------------------------------------------
char sub_105DAC(int a1, int a2, int a3, int a4, int a5)
{
  int v5; // esi
  int v6; // eax
...
//----- (00105DEF) --------------------------------------------------------
char sub_105DEF(int a1, int a2, int a3, int a4, int a5)
{
  char result; // al
...
//----- (00105EDC) --------------------------------------------------------
void sub_105EDC(int a1, int a2, unsigned int a3, int a4, int a5)
{
  if ( !a4 )
  {
    if ( a3 < 2u )
...
//----- (00105F89) --------------------------------------------------------
char sub_105F89(int a1, int a2, int a3, int a4, int a5)
{
  char result; // al
...
// 1ACF14: using guessed type int dword_1ACF14;
// 1ACF70: using guessed type int (*dword_1ACF70)(_DWORD, _DWORD, _DWORD);
// 1ACFB7: using guessed type int dword_1ACFB7;


//----- (00105FE9) --------------------------------------------------------
void sub_105FE9( unsigned int a1)
{
  int16_t v1; // bx
  ...
  if ( *(int16_t *)(dword_1ACF08 + 12) > 0 )
  {
    ...
    do
    {
      ...
      if ( *(_BYTE *)(dword_1ACF14 + 20) )
      {
            ...
            if ( word_1B3E86 != 2 )
            {
              ...
              sub_123070(
                ...
                *(_BYTE *)(dword_1ACF10 + 7),
                (int16_t *)(intptr_t)*(uint32_t *)(dword_1ACF14 + 16));
              sub_123070(
                v8,
                (int16_t)(*(_WORD *)(dword_1ACF10 + 2) + 1),
                *(_BYTE *)(dword_1ACF10 + 7),
        ...
        if ( *(_DWORD *)(dword_1ACF14 + 16) )
          sub_123070(v8, *(int16_t *)(dword_1ACF10 + 2), *(_BYTE *)(dword_1ACF10 + 7), (int16_t *)(intptr_t)*(uint32_t *)(dword_1ACF14 + 16));
        else
...
#define v27 (v24 + 3)
  ...
  sub_102CDF();
  sub_24E96(v25);
  v33 = (*(_BYTE *)(3753 * word_19999C + (uint8_t*)dword_197F98 + 3679) & 0x70) >> 4;
  v12 = 0;
...
LABEL_17:
    ...
    if ( a1 == word_1AD204 )
    {
      v21 = 3753 * word_19999C + (uint8_t*)dword_197F98;
      v22 = v33 & 7;
      ...
      *(_BYTE *)(v21 + 3679) |= 16 * v22;
      ...
      sub_119281();
      word_199A08 = 0;
      return;   /* vlna 79: JUMPOUT byl NO-OP, cil 0x107668 je epilog funkce */
    }
  }
}
#undef v25
...
//----- (0010709A) --------------------------------------------------------
int sub_10709A(int *a1, int a2, int a3)
{
  uint16_t v4; // si
  int v5; // edi
  int *v6; // eax
...
int sub_1078A9(int a1)
{
  ...
  do
  {
    ...
    LOWORD(v3) = *(uint8_t *)(3753 * word_19999C + (uint8_t*)dword_197F98 + 3679);
    v4 = v3 & (1 << result);
    v5 = (int16_t)result++;
    *(_WORD *)(a1 + 2 * v5) = v4;
  }
...
int sub_1078ED(int a1)
{
  ...
  do
  {
    if ( *(_WORD *)(a1 + 2 * (int16_t)result) )
      *(_BYTE *)((uint8_t*)dword_197F98 + 3753 * word_19999C + 3679) |= 1 << result;
    else
      *(_BYTE *)(3753 * word_19999C + (uint8_t*)dword_197F98 + 3679) &= ~(1 << result);
    ++result;
  }
  while ( (int16_t)result < 4 );
  return result;
...
void sub_10794C(int a1)
{
  ...
  do
  {
    ...
    LOWORD(v2) = *(uint8_t *)(3753 * word_19999C + (uint8_t*)dword_197F98 + 3679);
    v3 = (1 << v1) & v2;
    v4 = (int16_t)v1++;
    *(_WORD *)&v38[2 * v4] = v3;
  }
...
LABEL_72:
  ...
  while ( v8 >= 0 )
  {
    ...
    v54 = v7;
    v10 = 0;
    v7 = v9 + (uint8_t*)dword_197F98;
    v41 = v9 + (uint8_t*)dword_197F98;
    v11 = sub_1029D1(&v43);
...
//----- (00107D5B) --------------------------------------------------------
unsigned int sub_107D5B(int a1, int a2, int a3)
{
  int *v6; // eax
  int v7; // edi
  int *v8; // eax
...
void sub_107DEA()
{
  ...
  for ( i = 0; i < word_199934; ++i )
  {
    ...
    v4 = v0;
    v0 += 19;
    sub_1212B3(v1, v4, (uint8_t*)dword_197F98 + 3753 * v3 + 21);
    if ( i == 2 || i == 5 )
    {
      v0 = 64;
      v1 += v5;
...
int sub_107E95(int a1, int a2, int a3)
{
  ...
  do
  {
    LOWORD(a3) = *(uint8_t *)((uint8_t*)dword_197F98 + 3753 * word_19999C + 3679);
    a3 &= 1 << v4;
    v5 = (int16_t)v4++;
    *(&v16 + v5) = a3;
  }
...
// 108028: using guessed type int nullsub_16(_DWORD, _DWORD);
...
//----- (00108029) --------------------------------------------------------
int sub_108029( unsigned int a1, unsigned int a2, unsigned int a3)
{
  char *v4; // eax
...
//----- (00108073) --------------------------------------------------------
int sub_108073(int a1, int a2, int a3)
{
  int v3; // ebx
  _DWORD *v4; // edx
  int v5; // eax
...
LABEL_10:
  ServiceAudioTick_FE8BE((int)v18, v17, v16, v13);
  ...
  while ( 1 )
  {
    ...
    if ( byte_1AD206 )
    {
      ...
      if ( *(_BYTE *)(dword_1AD1E0 + 21) )
      {
        ...
        ServiceAudioTick_FE8BE(v25, 12, 176, v13);
        if ( v41 )
  ...
  ServiceAudioTick_FE8BE(v26, v17, v16, v13);
  return v15;
}
...
//----- (001088A0) --------------------------------------------------------
char sub_1088A0( int a1, int a2, unsigned int a3)
{
  int v4; // ecx
  int16_t v5; // di
  uint16_t v6; // bx
  ...
  v4 = a2;
  v12 = (uint8_t*)dword_197F98 + 3753 * a3 + 2207;
  v5 = 443;
  v15 = a1 + 175;
  v13 = 442;
  v6 = 0;
...
int sub_1089C6(int a1, int a2)
{
  ...
  do
  {
    ...
    *(_DWORD *)&v32[v37 + 32] = v4;
    ...
    else
    {
      ...
      v36 = v5;
      v6 = v37;
      strcpy(v32, (char *)(3753 * v5 + (uint8_t*)dword_197F98 + 21));
      strupr(v32);
  ...
  if ( word_199934 > 4 )
    sub_1151B0(385, 427, (int)&unk_17A28B, ((_WORD *)(uintptr_t)*(uint32_t *)(v25 + 80)), &unk_17A28B, 40);
  ...
  do
  {
    ...
    do
    {
      ...
      v36 = 3753 * v16;
      if ( *(_BYTE *)(3753 * v16 + (uint8_t*)dword_197F98 + 36) )
      {
        v16 = (int)v33;
...
// 108E62: using guessed type int nullsub_17(_DWORD, _DWORD);
// 13EE59: using guessed type int strupr(_DWORD);
...
//----- (00108E63) --------------------------------------------------------
int sub_108E63(int result, int a2, unsigned int a3)
{
  int16_t v3; // cx
...
int sub_108EC3(int result, int a2, int a3, int a4)
{
  ...
  if ( (_WORD)a2 )
  {
    v5 = ((_BYTE *)(uintptr_t)*(uint32_t *)(result + 22));
    *(_BYTE *)(result + 21) = a2;
...
// 108F97: using guessed type int nullsub_18(_DWORD);
...
// 24E54: using guessed type int sub_24E54(_DWORD, _DWORD);
...
int16_t sub_109762(int a1)
{
  ...
  sub_124DEC();
  v4 = ((_WORD *)(uintptr_t)*(uint32_t *)(v8 + 84));
...
//----- (00109F9E) --------------------------------------------------------
void sub_109F9E(int16_t *a1, unsigned int a2)
{
  int16_t *v2; // ebx
  unsigned int v3; // edx
  ...
  return;   /* vlna 79: JUMPOUT byl NO-OP, cil 0x109F9C je epilog funkce */
}
...
int sub_109FBA(int a1)
{
  ...
  {
    v3 = (char *)&unk_183BE7 + 8 * *(uint8_t *)((uint8_t*)dword_197F98 + 3753 * (int16_t)result + 38);
    v4 = (int16_t)result;
...
int sub_10A036( int a1)
{
  ...
  *(_BYTE *)(v1 + (uint8_t*)dword_197F98 + 3679) &= 0x8Fu;
...
//----- (0010A064) --------------------------------------------------------
int16_t *sub_10A064(int16_t *result, int a2, unsigned int a3, unsigned int a4)
{
  int v5; // edx
...
void sub_10A3AD(int a1, int a2)
{
    ...
    if ( a2 != -7 )
    {
      ...
      if ( *(_DWORD *)(a1 + 34) )
      {
        ...
        for ( i = 0; i < (int)*(uint8_t *)(a2 + 73); ++i )
        {
          ...
          sub_120BB5(*(uint8_t *)(a1 + 33), v6);
          if ( byte_183F42 == 1
            && *(_BYTE *)(*(uint8_t *)(i + a2 + 126) + 3753 * word_19999C + (uint8_t*)dword_197F98 + 279) != 3 )
          {
  ...
  return;   /* vlna 79: JUMPOUT byl NO-OP, cil 0x10A33F je epilog funkce */
}
...
//----- (0010A689) --------------------------------------------------------
int16_t sub_10A689(int a1, int a2, int a3)
{
  if ( *(_BYTE *)(a1 + 31) < *(_BYTE *)(a1 + 30) )
    sub_1173DC(a3);
  else
...
//----- (0010A6C0) --------------------------------------------------------
int sub_10A6C0( int a1, int a2, char *a3)
{
  int v3; // edx
  int v4; // eax
  int v5; // ebx
  ...
  sub_103AB7();
  sub_1172FC();
  ServiceAudioTick_FE8BE(v4, (int)v46, a2, (int16_t *)a3);
  v47 = sub_126AFD((int)aRacesLbx_0, (int16_t)(*(uint8_t *)(dword_192BD8 + 37) + 32), dword_192ED4);
  v5 = dword_192ED4;
  v6 = (int16_t)(*(uint8_t *)((uint8_t*)dword_197F98 + 3753 * v34 + 37) + 46);
  v7 = 0;
  v8 = sub_126B42((int)aRacesLbx_0, v6, dword_192ED4);
  ServiceAudioTick_FE8BE((int)v8, v6, v5, (int16_t *)a3);
  do
  {
    v9 = dword_192ED4;
    ...
    v11 = (uint16_t)v7++;
    v41[v11] = (int)v10;
    ServiceAudioTick_FE8BE(v11, (int)v10, v9, (int16_t *)a3);
  }
...
LABEL_20:
  ...
  ServiceAudioTick_FE8BE(v15, v14, (int)v13, (int16_t *)a3);
  sub_249F9(aBilltextLbx_1, 31, v43, 40);
  LOBYTE(v25) = sub_249F9(aBilltextLbx_1, 32, v44, 40);
  ServiceAudioTick_FE8BE(v25, 32, (int)v44, (int16_t *)a3);
  sprintf(v35, "%s\n%s\n%s\n%s", v43, v38, v44, v40);
  ...
  do
  {
    ...
    v28 = sub_1297C3(70, 28, 76, 88, 1, (uint8_t)byte_1840B7[*(uint8_t *)(v27 + (uint8_t*)dword_197F98 + 38)]);
    ...
    ServiceAudioTick_FE8BE((int)v31, v30, v34, (int16_t *)a3);
    byte_183F42 = 0;
  }
  while ( (_WORD)v30 != word_1AD204 );
  sub_C5BB9();
  result = 3753 * word_19999C;
  dword_192BD8 = result + (uint8_t*)dword_197F98;
  return result;
}
...
LABEL_88:
      word_19994C = 0;
      ServiceAudioTick_FE8BE(v31, v29, v28, a1);
      dword_192BD8 = 3753 * word_19999C + (uint8_t*)dword_197F98;
      dword_1AD330 = (int)v76;
      dword_1AD398 = (int)v82;
      dword_1AD39C = (int)v78;
      ServiceAudioTick_FE8BE((int)v78, 25, v28, a1);
      sub_103AA2();
      sub_11C2F0();
      sub_124D41();
      sub_124C08();
      ...
      ServiceAudioTick_FE8BE((int)v70, 1, v69, v70);
      v71 = dword_192ED4;
      dword_1AD32C = (int)sub_126B42((int)aRacesLbx, 1, dword_192ED4);
      ServiceAudioTick_FE8BE(dword_1AD32C, 4, v71, v70);
      v72 = dword_192ED4;
      dword_1AD328 = (int)sub_126B42((int)aRacesLbx, 4, dword_192ED4);
      ServiceAudioTick_FE8BE(dword_1AD328, 4, v72, v70);
      switch ( byte_199CAE )
      {
        case 0:
        case 3:
      ...
      ServiceAudioTick_FE8BE((int)v85, v32, v33, v70);
      v34 = dword_192ED4;
      dword_1AD324 = (int)sub_126B42((int)aRacesLbx, 59, dword_192ED4);
      ServiceAudioTick_FE8BE(dword_1AD324, 59, v34, v70);
      sub_24E96(dword_1AD328);
      v35 = sub_102597(0, 0);
      ServiceAudioTick_FE8BE(v35, 0, v34, v70);
      sub_10BA3D((int)v76, (int)v82);
      ServiceAudioTick_FE8BE(v36, (int)v82, v34, v70);
      v78[0] = word_184099;
      v78[1] = word_18409B;
      v78[6] = 0;
      v78[2] = word_18409D;
      ...
      ServiceAudioTick_FE8BE(v37, 0, 639, v70);
      sub_128C32(0, 0, 639, 479, 0);
      v38 = sub_12A478(0, 0, (int)v70);
      ServiceAudioTick_FE8BE(v38, 0, (int)v70, v70);
      if ( sub_C5BB0() > 0 )
        sub_102CDF();
      sub_131B34();
      ServiceAudioTick_FE8BE(v39, 177, (int)v70, v70);
      sub_120DED(177, 177);
      sub_10BDED((int)v76);
      ServiceAudioTick_FE8BE(v40, 177, (int)v70, v70);
      sub_10BFBD((int)v76);
      ServiceAudioTick_FE8BE(v41, 0, (int)v70, v70);
      sub_10248B(0, 0);
      v42 = sub_10BD50((int)v76);
      ServiceAudioTick_FE8BE((int)v42, 0, (int)v70, v70);
      sub_124DEC();
      ...
      ServiceAudioTick_FE8BE(v46, 2, 639, v70);
      sub_10C8E0();
      ServiceAudioTick_FE8BE(v47, 2, 639, v70);
      v29 = 255;
      a1 = 0;
...
LABEL_38:
      if ( (_WORD)v49 == v94 )
      {
        ...
        sub_1172FC();
        word_199A08 = 0;
        return;   /* vlna 79: JUMPOUT byl NO-OP, cil 0x10BDE7 je epilog funkce */
      }
      goto LABEL_10;
    }
    if ( !byte_1AD595 )
    ...
    if ( (_WORD)v99 == v92 )
    {
      ...
      ServiceAudioTick_FE8BE(v52, v29, v28, a1);
      goto LABEL_88;
    }
    if ( (_WORD)v99 == v89 )
    {
    ...
    else
    {
      ...
      *(_BYTE *)((uint8_t*)dword_197F98 + 3753 * word_19999C + 3680) &= v29;
      ...
      v29 = (uint8_t*)dword_197F98;
      if ( *(_BYTE *)((uint8_t*)dword_197F98 + 3753 * *(int16_t *)(v84 + 2) + 40) == 100 )
      {
        v102 = 0;
        v101 = 0;
        v58 = *(_BYTE *)(v84 + 2);
        ...
        while ( !v102 && !sub_FA521(SBYTE1(v59)) && !v101 && !sub_FA5A3(*(int16_t *)(v84 + 2)) )
        {
          ...
          ServiceAudioTick_FE8BE(v62, 0, 639, a1);
          v59 = sub_12C2C6(2);
        }
        v63 = *(int16_t *)(v84 + 2);
        byte_1AD593 = 0;
...
LABEL_86:
      ...
      while ( !sub_FA2A9() && !v103 && !sub_FA3DC() )
      {
        ...
        ServiceAudioTick_FE8BE(v57, 0, 639, a1);
        sub_12C2C6(2);
      }
      byte_1AD593 = 0;
      if ( v103 )
...
void sub_10BA3D(int a1, int a2)
{
  ...
  v17 = sub_126B42(
          (int)aRacesLbx,
          (int16_t)(*(uint8_t *)((uint8_t*)dword_197F98 + 3753 * word_19999C + 37) + 46),
          dword_192ED4);
  v19 = 10;
  ...
  while ( 1 )
  {
    ...
    *(_DWORD *)(v2 + 64) = v16;
    if ( v25 < v5 )
    {
      ...
      v7 = (uint8_t*)dword_197F98 + 3753 * v6;
      v21 = 0;
...
void sub_10BDED(int a1)
{
  ...
  for ( i = 0; i < word_199934; ++i )
  {
    ...
    sub_1297C3(
      ...
      88,
      1,
      (uint8_t)byte_1840B7[*(uint8_t *)(3753 * *(int16_t *)(a1 + 2) + (uint8_t*)dword_197F98 + 38)]);
    sub_1297C3(
      word_183FF1[v2] + 1,
      word_183FF3[v2] + 1,
      74,
      86,
      1,
      (uint8_t)byte_1840BF[*(uint8_t *)((uint8_t*)dword_197F98 + 3753 * *(int16_t *)(a1 + 2) + 38)]);
    sub_12972D(
      word_183FF1[v2],
      word_183FF3[v2],
      byte_1840C7[*(uint8_t *)((uint8_t*)dword_197F98 + 3753 * *(int16_t *)(a1 + 2) + 38)]);
    sub_12972D(
      word_183FF1[v2] + 75,
      word_183FF3[v2],
      byte_1840C7[*(uint8_t *)(3753 * *(int16_t *)(a1 + 2) + (uint8_t*)dword_197F98 + 38)]);
    sub_12972D(
      word_183FF1[v2],
      word_183FF3[v2] + 87,
      byte_1840C7[*(uint8_t *)((uint8_t*)dword_197F98 + 3753 * *(int16_t *)(a1 + 2) + 38)]);
    v3 = byte_1840C7[*(uint8_t *)((uint8_t*)dword_197F98 + 3753 * *(int16_t *)(a1 + 2) + 38)];
    a1 += 84;
...
void sub_10BFBD(int a1)
{
  ...
  while ( 1 )
  {
    ...
    v21 = a1;
    if ( *(_BYTE *)(v14 + 10)
      || sub_79E06(word_19999C) && !*(_BYTE *)(3753 * word_19999C + (uint8_t*)dword_197F98 + *(int16_t *)(v14 + 2) + 1412) )
    {
      ...
      if ( v1 < word_199934 )
      {
        ...
        {
          a1 = (uint8_t*)dword_197F98 + 3753 * word_19999C;
...
LABEL_24:
    ...
    if ( *(_WORD *)((uint8_t*)dword_197F98 + 3753 * *(int16_t *)(v14 + 2) + 2 * word_19999C + 1599) )
    {
      ...
      if ( *(_WORD *)(3753 * *(int16_t *)(v14 + 2) + (uint8_t*)dword_197F98 + 2 * word_19999C + 1599) == 1 )
        v11 = 5;
      else
        v11 = 10;
      goto LABEL_48;
...
//----- (0010CBDF) --------------------------------------------------------
int sub_10CBDF( int a1, int16_t *a2)
{
  int v4; // eax
...
void sub_10CC4D(int16_t *a1)
{
  ...
  v2 = (int16_t *)(intptr_t)*(uint32_t *)(dword_1AD39C + 24);
