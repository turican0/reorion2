...
static inline unsigned char __readgsbyte(unsigned int off) { (void)off; return 0; }
static inline unsigned short __readgsword(unsigned int off) { (void)off; return 0; }
static inline void __writegsbyte(unsigned int off, unsigned char v) { (void)off; (void)v; }
static inline void __writegsword(unsigned int off, unsigned short v) { (void)off; (void)v; }
static inline void __writegsdword(unsigned int off, unsigned int v) { (void)off; (void)v; }
static inline void __addgsword(unsigned int off, unsigned short v) { (void)off; (void)v; }
